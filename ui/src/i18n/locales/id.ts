...
export const id: TranslationMap = {
  ...
  sessionsView: {
    ...
    cloudWorkerPlacementConflict: "Pekerja cloud: {state} · 1 konflik ruang kerja",
    cloudWorkerPlacementConflicts: "Pekerja cloud: {state} · {count} konflik ruang kerja",
    cloudWorkerDescendantConflict: "Turunan pekerja cloud: 1 konflik ruang kerja",
    cloudWorkerDescendantConflicts: "Turunan pekerja cloud: {count} konflik ruang kerja",
  ...
  configView: {
    ...
    sessionObserver: {
      ...
      toggle: "Pemantau sesi",
      toggleHint: "Buat ringkasan status langsung untuk sesi Control UI yang dilanggani.",
      resolvedModel: "Model kecil yang ditetapkan",
      ...
      modelPickerHint: "Digunakan untuk ringkasan pemantau dan tugas utilitas singkat lainnya.",
      modelCatalogUnavailable: "Katalog model eksplisit tidak tersedia",
      auto: "Otomatis (default penyedia)",
      disabled: "Dinonaktifkan",
      toggleNote: "Perbarui pemantau sesi Control UI",
  ...
  profilePage: {
    ...
    identity: {
      ...
      notSet: "Identitas belum ditetapkan.",
      setIdentity: "Tetapkan identitas",
      avatar: "Avatar",
      avatarDescription:
  ...
  gatewayLogs: {
    ...
    autoFollow: "Ikuti otomatis",
    file: "File: {file}",
    truncated: "Output log terpotong; menampilkan bagian terbaru.",
  ...
  workboard: {
    widget: {
      ...
      cardMissing: "Kartu Workboard ini sudah tidak tersedia.",
  ...
  chat: {
    ...
    board: {
      ...
      workboardCard: "Kartu papan kerja: {title}, {status}",
      defaultTab: "Utama",
    ...
    workspaceConflict: {
      titleOne: "1 konflik ruang kerja cloud",
      titleMany: "{count} konflik ruang kerja cloud",
      description:
        "OpenClaw mempertahankan versi lokal Anda dan menerapkan perubahan cloud lainnya. Periksa hasil yang telah disiapkan atau gunakan versinya untuk jalur yang berkonflik.",
      morePaths: "+{count} jalur lainnya",
      stagedResult: "Hasil cloud yang telah disiapkan",
      copyStagedResult: "Salin referensi hasil yang telah disiapkan",
      inspectCloud: "Periksa versi cloud pertama",
      takeCloud: "Gunakan versi cloud pertama",
      copyInspectCommand: "Salin perintah pemeriksaan cloud",
      copyTakeCommand: "Salin perintah take-cloud",
      commandHelp:
        "Jalankan perintah ini di Bash atau zsh (Git Bash di Windows). Jika pemeriksaan menyatakan jalur tidak ada, cloud telah menghapusnya; verifikasi dan hapus jalur lokal secara manual. Jika checkout melaporkan konflik file/direktori, pindahkan atau hapus jalur lokal yang menghalangi, lalu coba lagi. Jika referensi yang telah disiapkan tidak ditemukan, pemberitahuan ini sudah usang; jangan ubah jalur lokal.",
      commandsUnavailable:
        "Nama file ini berisi karakter kontrol terminal, sehingga OpenClaw tidak akan membuat perintah shell yang dapat disalin untuknya. Periksa referensi yang telah disiapkan secara langsung dan masukkan jalur secara manual dengan hati-hati.",
      ...
      eventDescription:
        "Versi lokal dipertahankan untuk jalur ini; perubahan cloud lainnya telah diterapkan.",
    },
    compaction: {
    ...
    observer: {
      ...
      running: "Berjalan",
      checksPassing: "{count} berhasil",
      checksFailing: "{count} gagal",
      checksPending: "{count} sedang berjalan",
      askLabel: "Tanyakan tentang sesi ini",
      askPlaceholder: "Mengapa ini melakukan itu?",
      askSubmit: "Tanya",
      askPending: "Memeriksa pengamatan…",
      askBusy: "Pengamat sedang menjawab pertanyaan lain.",
      askUnavailable: "Pengamat tidak dapat menjawab saat ini.",
      health: {
        "on-track": "Sesuai rencana",
        grinding: "Sedang bekerja",
        stuck: "Terhenti",
        "waiting-on-user": "Menunggu Anda",
        "wrapping-up": "Sedang menyelesaikan",
        done: "Selesai",
        failed: "Gagal",
      },
    },
  ...
  cron: {
    ...
    form: {
      ...
      script: "Skrip",
      readOnlyPayloadHelp:
        "Payload ini dibuat di luar Control UI. Isinya tetap hanya-baca dan dipertahankan saat Anda menyimpan perubahan lainnya.",
