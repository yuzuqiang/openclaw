...
export const id: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Keluar.",
      logoutNotCleared:
        "Tidak ada sesi WhatsApp tersimpan yang dihapus. Mungkin sudah tidak ada, atau direktori auth-nya memerlukan pembersihan manual.",
    },
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Offline — buka Setelan",
  ...
  sessionsView: {
    ...
    cloudWorkerDescendantConflict: "Anak cloud worker: 1 konflik workspace",
    cloudWorkerDescendantConflicts: "Anak cloud worker: {count} konflik workspace",
  ...
  configView: {
    ...
    sessionObserver: {
      ...
      resolvedModel: "Model kecil yang telah ditetapkan",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Perubahan pada sistem ini, terbaru lebih dulu.",
      ...
      invalidEdit: "Suntingan manual ini tidak lolos validasi konfigurasi.",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Perubahan tersimpan seketika dan berlaku untuk pengoperasian agen berikutnya.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      plugins: {
        ...
        desc: "Perluas OpenClaw dengan channel, alat, dan skill dari komunitas.",
      },
    },
  },
  presence: {
  ...
  gatewayLogs: {
    ...
    autoFollow: "Ikuti otomatis",
    file: "File: {file}",
    truncated: "Output log dipotong; menampilkan bagian terbaru.",
  ...
  board: {
    ...
    emptyTitle: "Papan kosong, siap untuk bekerja",
  ...
  chat: {
    ...
    startupStatus: {
      ...
      provisioningEnvironment: "Menyiapkan lingkungan…",
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Pengalihan branch memerlukan akses admin operator.",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw menyimpan versi lokal Anda dan menerapkan perubahan cloud lainnya. Periksa hasil yang di-stage atau ambil versinya untuk jalur yang berkonflik.",
      ...
      commandHelp:
        "Jalankan perintah ini di Bash atau zsh (Git Bash di Windows). Jika inspect menyatakan jalur tidak ada, cloud telah menghapusnya; verifikasi dan hapus jalur lokal secara manual. Jika checkout melaporkan konflik file/direktori, pindahkan atau hapus jalur lokal yang menghalangi, lalu coba lagi. Jika ref yang di-stage hilang, pemberitahuan ini usang; jangan ubah jalur lokal.",
      commandsUnavailable:
        "Nama file ini berisi karakter kontrol terminal, sehingga OpenClaw tidak akan membuat perintah shell yang dapat disalin untuknya. Periksa ref yang di-stage secara langsung dan masukkan jalur secara manual dengan hati-hati.",
    ...
    composer: {
      ...
      dictationDisconnected: "Dikte berhenti karena Gateway terputus.",
