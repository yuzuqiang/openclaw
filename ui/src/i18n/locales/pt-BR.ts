...
export const pt_BR: TranslationMap = {
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Offline — abrir Ajustes",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Os workers na nuvem exigem o runtime do OpenClaw; {runtime} está selecionado.",
  ...
  sessionsView: {
    ...
    sessionState: "Estado da conversa",
    viewArchived: "Ver arquivadas",
    sessionArchived: "Conversa arquivada",
    ...
    attentionRequired: "A sessão requer atenção",
    model: "Modelo",
    provider: "Provedor",
    runtime: "Runtime",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG ou WebP. As imagens são cortadas a partir do centro e redimensionadas para 512 px.",
      ...
      avatarTooLarge: "O avatar processado ainda é muito grande.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "As notificações do OpenClaw estão desativadas no macOS. Permita-as em Ajustes do Sistema > Notificações.",
    },
    appearance: {
      theme: "Tema",
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Mostrar atividade do agente em tempo real na barra lateral",
      liveActivityHint:
  ...
  subtitles: {
    ...
    apps: "Aplicativos complementares para celular, relógio, computador e navegador.",
    ...
    notifications: "Notificações push do seu gateway no navegador.",
    security: "Autenticação do Gateway, política de execução, perfil de ferramentas e aprovações.",
    advanced: "Todas as demais seções de configuração, além do editor de arquivos brutos.",
  ...
  custodian: {
    ...
    sensitivePlaceholder: "Insira um valor confidencial…",
    sensitiveReply: "Resposta confidencial enviada",
    send: "Enviar",
    ...
    history: {
      ...
      description: "O que mudou neste sistema, começando pelas alterações mais recentes.",
      ...
      opaqueChange:
        "A formatação ou os comentários foram alterados sem mudanças visíveis nos caminhos da configuração.",
      sources: {
    ...
    nudge: {
      configReload: "O recarregamento da configuração foi interrompido — pergunte o que aconteceu",
      channelAuth: "A autenticação de {channel} está comprometida — pergunte o que aconteceu",
      channelDisconnected: "{channel} acabou de se desconectar — pergunte o que aconteceu",
      channelDegraded: "{channel} está com desempenho comprometido — pergunte o que aconteceu",
  ...
  mcpServers: {
    ...
    disabledSuccess: "Servidor MCP {name} desabilitado.",
    removedSuccess: "Servidor MCP {name} removido.",
    configUnavailable: "A configuração não está disponível; atualize e tente novamente.",
    connectRequired: "Conecte-se ao Gateway para alterar os servidores MCP.",
    adminRequired: "As alterações nos servidores MCP exigem acesso operator.admin.",
    enable: "Ativar",
    disable: "Desabilitar",
  ...
  mcpPage: {
    connectorsLink: "Encontre conectores de instalação com um clique na página Plugins.",
    servers: "Servidores",
    oauth: "OAuth",
    filtered: "Filtrado",
  ...
  labsPage: {
    intro:
      "O Labs contém recursos experimentais que podem mudar, apresentar falhas ou desaparecer entre versões.",
    sectionTitle: "Recursos experimentais",
    sectionDescription:
      "As alterações são salvas imediatamente e aplicadas às futuras execuções dos agentes.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicativos complementares para seu celular, relógio, computador e navegador — além de plugins para ampliar o que seu agente pode fazer.",
    sectionMobile: "No seu celular",
    havePhone: "Já tem o app?",
    ...
    badgeBundledIos: "Incluído no app para iOS",
    badgeBundledAndroid: "Incluído no app para Android",
    ...
    ctaBrowseClawHub: "Explorar o ClawHub",
    linkDiscord: "Comunidade do Discord",
    linkDocs: "Documentação",
    cards: {
      ios: {
        title: "iPhone",
        desc: "Converse, fale, aprove ações e compartilhe conteúdo no OpenClaw pelo iOS.",
      },
      android: {
        title: "Android",
        desc: "Seu celular Android como um nó completo do OpenClaw — com chat, câmera e Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Conversas rápidas de consultar e respostas rápidas direto do seu pulso.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "O app complementar para Android leva o OpenClaw ao seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "Companheiro da barra de menus para seu Gateway — notificações, aprovações e chat rápido.",
      },
      windows: {
        title: "Windows",
        desc: "O aplicativo complementar para Windows conecta seu PC como um nó do OpenClaw.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Permita que o OpenClaw controle seu Chrome atual — abas, páginas e formulários.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG ou WebP. As imagens são redimensionadas para 256 × 256 ou menos.",
      ...
      openSettings: "Abrir as configurações de identidade de {name}",
      avatarErrors: {
        invalid: "Não foi possível processar essa imagem.",
        sourceTooLarge: "Escolha uma imagem de até 10 MB.",
  ...
  board: {
    ...
    emptyTitle: "Um painel vazio, pronto para o trabalho",
    emptyHint: "Seu agente pode fixar widgets aqui — tente pedir um cartão de status.",
    actionFailed: "Não foi possível salvar a alteração no painel.",
    actionInProgress: "Outra alteração no painel ainda está sendo salva.",
    announcement: {
      moved: "{title} foi movido.",
      resized: "{title} foi redimensionado.",
      removed: "{title} foi removido.",
      granted: "Acesso ao widget permitido.",
      rejected: "Acesso ao widget rejeitado.",
    },
    widget: {
      cellLabel:
        "Widget do painel: {title}. Use as teclas de seta para navegar. Mantenha Alt pressionado e pressione uma tecla de seta para movê-lo.",
      ...
      sandboxOriginRequired:
        "A autorização do widget falhou após repetidas tentativas de atualização. Se o Gateway estiver sendo executado por trás de um proxy reverso ou túnel que não roteia a porta do sandbox do widget, defina mcp.apps.sandboxOrigin como uma origem pública dedicada roteada para o listener do sandbox.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Ainda não há um painel — o agente em execução pode fixar widgets.",
    openSession: "Abrir sessão",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable:
        "Não é possível alternar entre ramificações enquanto o agente está trabalhando.",
      branchSwitchRequiresAdmin:
        "A alternância entre ramificações requer acesso de administrador do operador.",
    ...
    board: {
      ...
      dockBottom: "Encaixar chat na parte inferior",
      ...
      mockPlaceholder: "Divisão da visualização do painel · {tabs} abas · {widgets} widgets",
      ...
      resetDescription: "O contexto da conversa será redefinido. Seu painel permanecerá.",
    },
    catalog: {
    ...
    workspaceConflict: {
      titleOne: "1 conflito no espaço de trabalho na nuvem",
      titleMany: "{count} conflitos no espaço de trabalho na nuvem",
      description:
        "O OpenClaw manteve suas versões locais e aplicou as outras alterações da nuvem. Inspecione o resultado preparado ou use a versão da nuvem para um caminho com conflito.",
      morePaths: "Mais {count} caminhos",
      stagedResult: "Resultado da nuvem preparado",
      copyStagedResult: "Copiar referência do resultado preparado",
      ...
      commandHelp:
        "Execute estes comandos no Bash ou zsh (Git Bash no Windows). Se a inspeção informar que o caminho não existe, ele foi excluído da nuvem; verifique e remova o caminho local manualmente. Se o checkout relatar um conflito de arquivo/diretório, mova ou remova o caminho local que está bloqueando e tente novamente. Se a referência preparada estiver ausente, o aviso está desatualizado; não altere o caminho local.",
      commandsUnavailable:
        "Este nome de arquivo contém caracteres de controle do terminal, portanto, o OpenClaw não criará um comando shell copiável para ele. Inspecione a referência preparada diretamente e insira o caminho manualmente com cuidado.",
      dismiss: "Dispensar aviso de conflito no espaço de trabalho",
      eventSender: "Espaço de trabalho na nuvem",
    ...
    messages: {
      ...
      rewindUnavailable: "Não é possível retroceder enquanto o agente está trabalhando",
      forkUnavailable: "Não é possível criar uma ramificação enquanto o agente está trabalhando",
    ...
    modelControls: {
      ...
      reasoning: "Raciocínio",
      speed: "Velocidade",
      sessionOverride: "Substituição da sessão",
    ...
    composer: {
      ...
      cameraInput: "Câmera",
      cameraListUnsupported: "Este navegador não pode listar as câmeras.",
      ...
      microphoneAppliesNextSession:
        "As alterações serão aplicadas quando você iniciar sua próxima sessão de conversa.",
      ...
      holdToRecordSettingDescription:
        "Mantenha o botão do microfone do campo de mensagem pressionado, fale e solte para inserir o texto sem enviá-lo.",
      dictationAudioUnsupported: "O Gateway retornou um formato de áudio de ditado não compatível.",
      dictationBrowserAudioUnsupported: "Este navegador não pode capturar áudio de ditado a 8 kHz.",
      ...
      selectedCameraUnavailable:
        "A câmera selecionada não está disponível. Escolha outra câmera ou use o padrão do sistema.",
