...
export const pt_BR: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nenhuma sessão armazenada do WhatsApp foi limpa. Ela pode já estar ausente, ou seu diretório de autenticação pode precisar de limpeza manual.",
    },
  ...
  quickSettings: {
    ...
    personal: {
      ...
      avatarTooLarge: "O avatar processado ainda está grande demais.",
  ...
  configView: {
    ...
    sessionObserver: {
      ...
      modelUnavailable: "indisponível (sem modelo pequeno)",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "O que mudou neste sistema, das mais recentes às mais antigas.",
      ...
      opaqueChange:
        "A formatação ou os comentários mudaram sem alterações visíveis no caminho de configuração.",
      sources: {
    ...
    nudge: {
      configReload: "Recarregamento da configuração interrompido — me pergunte o que aconteceu",
      channelAuth: "Autenticação do {channel} degradada — me pergunte o que aconteceu",
      channelDisconnected: "{channel} acabou de desconectar — me pergunte o que aconteceu",
      channelDegraded: "{channel} está degradado — me pergunte o que aconteceu",
  ...
  labsPage: {
    ...
    sectionDescription:
      "As alterações são salvas imediatamente e aplicam-se a execuções futuras do agente.",
  ...
  appsPage: {
    ...
    pairDevice: "Pareie seu dispositivo",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Conversas rápidas e respostas ágeis no seu pulso.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Companheiro na barra de menus para o seu Gateway — notificações, aprovações e chat rápido.",
      },
      windows: {
        title: "Windows",
        desc: "O companheiro Windows conecta o seu PC como um nó do OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "App desktop nativo — builds .deb e AppImage.",
      },
      chrome: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG ou WebP. As imagens são redimensionadas para 256 × 256 ou menores.",
      ...
      openSettings: "Abrir configurações de identidade para {name}",
      avatarErrors: {
  ...
  gatewayLogs: {
    ...
    autoFollow: "Acompanhamento automático",
    file: "Arquivo: {file}",
    truncated: "Saída de log truncada; exibindo o bloco mais recente.",
  ...
  board: {
    ...
    widget: {
      ...
      sandboxUnavailable: "O host da sandbox do widget está indisponível.",
      frameAuthorizationFailed:
        "A autorização do widget falhou após repetidas tentativas de atualização.",
      sandboxOriginRequired:
        "A autorização do widget falhou após repetidas tentativas de atualização. Se o gateway for executado atrás de um proxy reverso ou túnel que não roteia a porta da sandbox do widget, defina mcp.apps.sandboxOrigin para uma origem pública dedicada roteada ao listener da sandbox.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Ainda não há painel — o agente ativo pode fixar widgets.",
    openSession: "Abrir sessão",
  ...
  chat: {
    ...
    workspaceConflict: {
      ...
      description:
        "O OpenClaw manteve suas versões locais e aplicou as outras alterações da nuvem. Inspecione o resultado preparado ou use a versão dele para um caminho em conflito.",
      morePaths: "+{count} outros caminhos",
      ...
      commandsUnavailable:
        "Este nome de arquivo contém caracteres de controle de terminal, então o OpenClaw não criará um comando shell copiável para ele. Inspecione a ref preparada diretamente e insira o caminho manualmente com cuidado.",
      ...
      eventDescription:
        "As versões locais foram mantidas para estes caminhos; outras alterações da nuvem foram aplicadas.",
    },
    compaction: {
    ...
    modelControls: {
      ...
      reasoning: "Raciocínio",
      speed: "Velocidade",
      sessionOverride: "Substituição da conversa",
    ...
    observer: {
      ...
      running: "Em execução",
      checksPassing: "{count} aprovados",
      checksFailing: "{count} falharam",
      checksPending: "{count} em execução",
      askLabel: "Pergunte sobre esta sessão",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Falha ao exportar widget. Tente novamente.",
