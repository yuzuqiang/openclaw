...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı hiçbir WhatsApp oturumu temizlenmedi. Zaten yok olabilir veya kimlik doğrulama dizini manuel temizlik gerektirebilir.",
    },
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Çevrimdışı — Ayarlar'ı açın",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "İşleniyor…",
      profileHint:
        "JPEG, PNG veya WebP. Görüntüler merkezden kırpılır ve 512 piksele yeniden boyutlandırılır.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Bildirimler bu Mac'te OpenClaw uygulaması tarafından doğal olarak gösterilir.",
      ...
      nativeBlockedHint:
        "macOS'ta OpenClaw için bildirimler devre dışı. Bunlara Sistem Ayarları > Bildirimler'den izin verin.",
    },
    appearance: {
      theme: "Tema",
  ...
  execApproval: {
    ...
    reviewRequest: "{agent} tarafından gönderilen onayı inceleyin: {command}",
  ...
  custodian: {
    ...
    placeholder: "OpenClaw'a mesaj gönderin…",
    ...
    history: {
      ...
      description: "Bu sistemde neler değişti, en yeniden başlayarak.",
      ...
      invalidEdit: "Bu manuel düzenleme yapılandırma doğrulamasından geçemedi.",
      opaqueChange:
        "Biçimlendirme veya yorumlar, görünür yapılandırma yolu değişiklikleri olmadan değişti.",
      sources: {
  ...
  mcpPage: {
    connectorsLink: "Eklentiler sayfasında tek tıkla bağlayıcıları keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  appsPage: {
    ...
    havePhone: "Uygulama zaten var mı?",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS'ta sohbet edin, konuşun, işlemleri onaylayın ve OpenClaw'a paylaşın.",
      },
      android: {
        title: "Android",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Android yardımcı uygulaması OpenClaw'ı saatinize genişletir.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Windows yardımcı uygulaması, PC'nizi bir OpenClaw düğümü olarak bağlar.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "OpenClaw'un mevcut Chrome'unuzu kullanmasına izin verin — sekmeler, sayfalar ve formlar.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG veya WebP. Görseller 256 × 256 veya daha küçük boyuta getirilir.",
  ...
  board: {
    ...
    widget: {
      ...
      hostTools: "Host araçları ve verileri",
      ...
      appStaleDetail: "Sunucusu, kaynağı veya kaynak dökümü artık kullanılamıyor.",
      retry: "Tekrar dene",
      frameResolverMissing: "Widget içeriği kullanılamıyor.",
      sandboxUnavailable: "Widget sandbox ana bilgisayarı kullanılamıyor.",
      ...
      sandboxOriginRequired:
        "Tekrarlanan yenileme denemelerinden sonra widget yetkilendirmesi başarısız oldu. Gateway, widget sandbox bağlantı noktasını yönlendirmeyen bir ters proxy veya tünel arkasında çalışıyorsa, mcp.apps.sandboxOrigin değerini sandbox dinleyicisine yönlendirilen özel bir genel köken olarak ayarlayın.",
      ...
      disabledPlugin: "Devre dışı bırakılan {pluginId} eklentisinden widget",
    },
  },
  workboard: {
    widget: {
      ...
      cardIdRequired: "Bu widget bir cardId özelliği gerektirir.",
    ...
    dashboardTitle: "Pano",
    dashboardEmpty: "Henüz pano yok — çalışan aracı widget'ları sabitleyebilir.",
    openSession: "Oturumu aç",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Sohbeti sola yuvala",
      dockRight: "Sohbeti sağa yuvala",
      dockBottom: "Sohbeti alta yuvala",
      ...
      resetTitle: "Sohbet sıfırlansın mı?",
      resetDescription: "Sohbet bağlamı sıfırlanır. Panonuz kalır.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      copyTakeCommand: "Bulut-al komutunu kopyala",
      commandHelp:
        "Bunları Bash veya zsh'de (Windows'ta Git Bash) çalıştırın. İnceleme yolun mevcut olmadığını söylerse, bulut onu silmiştir; doğrulayın ve yerel yolu manuel olarak kaldırın. Checkout bir dosya/dizin çakışması bildirirse, engelleyen yerel yolu taşıyın veya kaldırın, ardından yeniden deneyin. Hazırlanan referans eksikse, uyarı bayattır; yerel yolu değiştirmeyin.",
      commandsUnavailable:
        "Bu dosya adı terminal denetim karakterleri içeriyor, bu yüzden OpenClaw bunun için kopyalanabilir bir shell komutu oluşturmaz. Hazırlanan referansı doğrudan inceleyin ve yolu dikkatlice manuel olarak girin.",
    ...
    modelControls: {
      ...
      reasoning: "Akıl yürütme",
      speed: "Hız",
      sessionOverride: "Konu geçersiz kılma",
    ...
    observer: {
      title: "Oturum gözlemcisi",
      expand: "Oturum gözlemleyiciyi genişlet",
      collapse: "Oturum gözlemleyiciyi daralt",
      plan: "Plan",
      ...
      askBusy: "Gözlemleyici zaten bir soruyu yanıtlıyor.",
      askUnavailable: "Gözlemleyici şu anda yanıt veremiyor.",
      health: {
        "on-track": "Yolunda",
        grinding: "Çalışıyor",
        stuck: "Takıldı",
    ...
    composer: {
      ...
      cameraInput: "Kamera",
      cameraListUnsupported: "Bu tarayıcı kameraları listeleyemez.",
      ...
      dictationBrowserAudioUnsupported: "Bu tarayıcı dikte sesini 8 kHz'de yakalayamaz.",
      ...
      dictationFinalizationTimedOut: "Son kısmi transkript tamamlanamadan dikte durduruldu.",
      ...
      selectedCameraUnavailable:
        "Seçili kamera kullanılamıyor. Başka bir kamera veya Sistem varsayılanını seçin.",
    ...
    toolCards: {
      ...
      widgetActions: "Widget işlemleri",
      copyToClipboard: "Panoya kopyala",
      downloadFile: "Dosyayı indir",
      widgetExportRerender:
        "Bu widget'ın görüntü olarak dışa aktarılması için yeniden işlenmesi gerekir.",
