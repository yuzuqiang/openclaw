...
export const tr: TranslationMap = {
  ...
  newSession: {
    ...
    gitCheckUnavailable:
      "Bu klasör için Git doğrulanamadı. Yeniden denemek için klasörü tekrar seçin.",
  ...
  configView: {
    ...
    sessionObserver: {
      ...
      hint: "Uzun süre çalışan oturumları küçük bir yardımcı modelle özetleyin.",
      ...
      modelCatalogUnavailable: "Belirli model kataloğu kullanılamıyor",
      auto: "Otomatik (sağlayıcı varsayılanı)",
      disabled: "Devre dışı",
      toggleNote: "Control UI oturum gözlemcisini güncelleyin",
      modelNote: "Varsayılan yardımcı modeli güncelleyin",
    },
    connection: {
      title: "Bağlantı",
      gateway: "Gateway",
  ...
  board: {
    ...
    widget: {
      ...
      disabledPlugin: "Devre dışı bırakılmış {pluginId} eklentisinden widget",
    },
  },
  workboard: {
    widget: {
      ...
      cardIdRequired: "Bu widget için cardId prop'u gereklidir.",
    ...
    dashboardEmpty: "Henüz bir pano yok — çalışan aracı pencere öğelerini sabitleyebilir.",
    openSession: "Oturumu aç",
  ...
  chat: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw yerel sürümlerinizi korudu ve diğer bulut değişikliklerini uyguladı. Hazırlanan sonucu inceleyin veya çakışan yol için bulut sürümünü kullanın.",
      ...
      takeCloud: "İlk bulut sürümünü kullan",
      copyInspectCommand: "Bulut inceleme komutunu kopyala",
      copyTakeCommand: "Bulut sürümünü kullanma komutunu kopyala",
      commandHelp:
        "Bunları Bash veya zsh'de (Windows'ta Git Bash) çalıştırın. İnceleme komutu yolun mevcut olmadığını söylüyorsa bulut bu yolu silmiştir; doğrulayın ve yerel yolu manuel olarak kaldırın. Checkout bir dosya/dizin çakışması bildirirse engel oluşturan yerel yolu taşıyın veya kaldırın, ardından yeniden deneyin. Hazırlanan referans eksikse bildirim güncel değildir; yerel yolu değiştirmeyin.",
      commandsUnavailable:
        "Bu dosya adı terminal kontrol karakterleri içerdiğinden OpenClaw bunun için kopyalanabilir bir kabuk komutu oluşturmayacaktır. Hazırlanan referansı doğrudan inceleyin ve yolu dikkatle manuel olarak girin.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Betik",
      readOnlyPayloadHelp:
        "Bu yük Control UI dışında oluşturuldu. İçeriği salt okunur olarak kalır ve diğer değişiklikleri kaydettiğinizde korunur.",
