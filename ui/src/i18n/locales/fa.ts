...
export const fa: TranslationMap = {
  ...
  newSession: {
    ...
    worktree: "Worktree",
    checkingGit: "در حال بررسی دسترس‌پذیری Git…",
    gitCheckUnavailable:
      "تأیید Git برای این پوشه ممکن نشد. برای تلاش مجدد، دوباره آن را انتخاب کنید.",
  ...
  sessionsView: {
    ...
    cloudWorkerPlacementConflict: "عامل ابری: {state} · ۱ تداخل فضای کاری",
    cloudWorkerPlacementConflicts: "عامل ابری: {state} · {count} تداخل فضای کاری",
    cloudWorkerDescendantConflict: "عامل زیرمجموعهٔ ابری: ۱ تداخل فضای کاری",
    cloudWorkerDescendantConflicts: "عامل‌های زیرمجموعهٔ ابری: {count} تداخل فضای کاری",
  ...
  configView: {
    ...
    sessionObserver: {
      title: "ناظر نشست",
      hint: "نشست‌های طولانی‌مدت را با یک مدل کمکی کوچک خلاصه کنید.",
      toggle: "ناظر نشست",
      toggleHint: "برای نشست‌های مشترک‌شده Control UI، خلاصه‌های زنده وضعیت ایجاد کنید.",
      resolvedModel: "مدل کوچک نهایی",
      modelAuto: "خودکار ({model})",
      modelConfigured: "پیکربندی‌شده ({model})",
      modelDisabled: "غیرفعال",
      modelUnavailable: "دردسترس نیست (مدل کوچکی وجود ندارد)",
      modelPicker: "مدل کوچک",
      modelPickerHint: "برای خلاصه‌های ناظر و دیگر وظایف کمکی کوتاه استفاده می‌شود.",
      modelCatalogUnavailable: "فهرست صریح مدل‌ها دردسترس نیست",
      auto: "خودکار (پیش‌فرض ارائه‌دهنده)",
      disabled: "غیرفعال",
      toggleNote: "به‌روزرسانی ناظر نشست Control UI",
      modelNote: "به‌روزرسانی مدل کمکی پیش‌فرض",
    },
    connection: {
      title: "اتصال",
      gateway: "Gateway",
  ...
  gatewayLogs: {
    ...
    exportButton: "خروجی گرفتن از {label}",
    exportLabels: {
      filtered: "فیلترشده",
      visible: "قابل مشاهده",
    },
    ...
    autoFollow: "دنبال‌کردن خودکار",
    file: "فایل: {file}",
    truncated: "خروجی گزارش کوتاه شده است؛ آخرین بخش نمایش داده می‌شود.",
  ...
  workboard: {
    widget: {
      cardLabel: "کارت میز کار",
      summaryLabel: "خلاصه میز کار",
      loading: "در حال بارگذاری میز کار…",
      cardIdRequired: "این ویجت به ویژگی cardId نیاز دارد.",
      cardMissing: "این کارت میز کار دیگر در دسترس نیست.",
      unassigned: "تخصیص‌نیافته",
      openBoard: "باز کردن میز کار",
  ...
  chat: {
    ...
    startupStatus: {
      ...
      provisioningEnvironment: "در حال فراهم‌سازی محیط…",
    ...
    board: {
      ...
      reopenChat: "نمایش چت",
      workboardCard: "کارت میز کار: {title}، {status}",
      defaultTab: "اصلی",
    ...
    workspaceConflict: {
      titleOne: "۱ تداخل در فضای کاری ابری",
      titleMany: "{count} تداخل در فضای کاری ابری",
      description:
        "OpenClaw نسخه‌های محلی شما را حفظ کرد و سایر تغییرات ابری را اعمال کرد. نتیجه مرحله‌بندی‌شده را بررسی کنید یا برای مسیر دارای تداخل، نسخه ابری را بپذیرید.",
      ...
      takeCloud: "پذیرفتن اولین نسخه ابری",
      copyInspectCommand: "کپی فرمان بررسی نسخه ابری",
      copyTakeCommand: "کپی فرمان take-cloud",
      commandHelp:
        "این فرمان‌ها را در Bash یا zsh (در Windows،‏ Git Bash) اجرا کنید. اگر فرمان بررسی اعلام کرد که مسیر وجود ندارد، یعنی نسخه ابری آن را حذف کرده است؛ پس از تأیید، مسیر محلی را به‌صورت دستی حذف کنید. اگر checkout تداخل فایل/پوشه را گزارش کرد، مسیر محلی مسدودکننده را جابه‌جا یا حذف کنید و سپس دوباره تلاش کنید. اگر ارجاع مرحله‌بندی‌شده وجود ندارد، این اعلان قدیمی است؛ مسیر محلی را تغییر ندهید.",
      commandsUnavailable:
        "این نام فایل حاوی نویسه‌های کنترلی ترمینال است، بنابراین OpenClaw فرمان پوسته قابل‌کپی برای آن ایجاد نمی‌کند. ارجاع مرحله‌بندی‌شده را مستقیماً بررسی کنید و مسیر را با دقت به‌صورت دستی وارد کنید.",
      dismiss: "بستن اعلان تداخل فضای کاری",
      eventSender: "فضای کاری ابری",
      eventTitleOne: "نتیجه ابری با ۱ تداخل اعمال شد",
      eventTitleMany: "نتیجه ابری با {count} تداخل اعمال شد",
      eventDescription: "نسخه‌های محلی برای این مسیرها حفظ شدند؛ سایر تغییرات ابری اعمال شدند.",
    },
    compaction: {
    ...
    observer: {
      title: "ناظر نشست",
      expand: "باز کردن ناظر نشست",
      collapse: "بستن ناظر نشست",
      plan: "برنامه",
      ...
      askBusy: "ناظر در حال پاسخ‌گویی به پرسش دیگری است.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "اسکریپت",
      readOnlyPayloadHelp:
        "این محتوای ارسالی خارج از Control UI ایجاد شده است. محتوای آن فقط خواندنی باقی می‌ماند و هنگام ذخیره سایر تغییرات حفظ می‌شود.",
