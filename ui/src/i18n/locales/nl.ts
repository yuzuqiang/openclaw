...
export const nl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Uitgelogd.",
      logoutNotCleared:
        "Er is geen opgeslagen WhatsApp-sessie gewist. Deze is mogelijk al afwezig, of de auth-directory moet handmatig worden opgeschoond.",
    },
  ...
  newSession: {
    ...
    gitCheckUnavailable:
      "Kon Git voor deze map niet verifiëren. Kies deze opnieuw om het nog eens te proberen.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint: "Toon de meest recente assistent- of toolactiviteit onder actieve sessies.",
    },
    sessionObserver: {
      title: "Sessie-observator",
      hint: "Vat langlopende sessies samen met een klein hulpmodel.",
      toggle: "Sessie-observator",
      ...
      modelPickerHint: "Gebruikt voor observator-overzichten en andere korte hulptaken.",
      modelCatalogUnavailable: "Expliciete modelcatalogus niet beschikbaar",
      auto: "Auto (providerstandaard)",
      disabled: "Uitgeschakeld",
      toggleNote: "Werk de Control UI-sessie-observator bij",
  ...
  custodian: {
    ...
    earlier: "Eerder",
    requestFailed: "OpenClaw kon niet antwoorden. Probeer opnieuw.",
    connectionChanged:
    ...
    history: {
      ...
      sources: {
        ...
        settings: "instellingen",
        cli: "CLI",
        pluginInstall: "plug-in installeren",
        manualEdit: "handmatige bewerking",
        unknown: "onbekend",
      },
    },
    nudge: {
      configReload: "Configuratie opnieuw laden gestopt — vraag me wat er is gebeurd",
  ...
  mcpPage: {
    connectorsLink: "Ontdek one-click connectors op de Plugins-pagina.",
    servers: "Servers",
    oauth: "OAuth",
    filtered: "Gefilterd",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Snel te bekijken chats en snelle antwoorden vanaf je pols.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  gatewayLogs: {
    ...
    autoFollow: "Automatisch volgen",
    file: "Bestand: {file}",
    truncated: "Loguitvoer afgekapt; laatste deel wordt getoond.",
  ...
  board: {
    ...
    widget: {
      ...
      appStaleDetail:
        "De bijbehorende server, resource of oorspronkelijk transcript is niet meer beschikbaar.",
      retry: "Opnieuw proberen",
      frameResolverMissing: "Widgetinhoud is niet beschikbaar.",
      sandboxUnavailable: "De sandboxhost voor de widget is niet beschikbaar.",
      frameAuthorizationFailed: "Widgetautorisatie is mislukt na herhaalde vernieuwpogingen.",
      sandboxOriginRequired:
        "Widgetautorisatie is mislukt na herhaalde vernieuwpogingen. Als de gateway achter een reverse proxy of tunnel draait die de sandboxpoort van de widget niet routeert, stel dan mcp.apps.sandboxOrigin in op een specifieke openbare oorsprong die naar de sandboxlistener wordt gerouteerd.",
      ...
      kindHtml: "HTML",
      kindPlugin: "Plugin",
      pluginLoading: "Plugin-widget laden…",
  ...
  workboard: {
    widget: {
      ...
      statusCounts: "Kaarten op status",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Vertakking wisselen vereist beheerderstoegang van de operator.",
    ...
    workspaceConflict: {
      titleOne: "1 cloudworkspaceconflict",
      titleMany: "{count} cloudworkspaceconflicten",
      description:
        "OpenClaw heeft je lokale versies behouden en de andere cloudwijzigingen toegepast. Bekijk het voorbereide resultaat of neem de versie ervan over voor een pad met een conflict.",
      morePaths: "+{count} extra paden",
      stagedResult: "Voorbereid cloudresultaat",
      copyStagedResult: "Ref van voorbereid resultaat kopiëren",
      ...
      commandHelp:
        "Voer deze uit in Bash of zsh (Git Bash op Windows). Als inspect meldt dat het pad niet bestaat, heeft de cloud het verwijderd; controleer en verwijder het lokale pad handmatig. Als checkout een bestands-/mapconflict meldt, verplaats of verwijder het blokkerende lokale pad en probeer het opnieuw. Als de staged ref ontbreekt, is de melding verouderd; wijzig het lokale pad niet.",
      commandsUnavailable:
        "Deze bestandsnaam bevat besturingstekens voor de terminal, dus OpenClaw maakt er geen kopieerbare shell-opdracht voor. Inspecteer de staged ref rechtstreeks en voer het pad zorgvuldig handmatig in.",
      ...
      eventDescription:
        "Voor deze paden zijn lokale versies behouden; andere cloudwijzigingen zijn toegepast.",
    },
    compaction: {
    ...
    messages: {
      ...
      forkUnavailable: "Splitsen is niet beschikbaar terwijl de agent werkt",
    ...
    modelControls: {
      ...
      resetToDefault: "Terug naar standaard ({model})",
    },
    sideChat: {
      title: "Zijgesprek",
    ...
    observer: {
      ...
      askLabel: "Vraag iets over deze sessie",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Houd de microfoonknop van de composer ingedrukt, spreek en laat dan los om tekst in te voegen zonder te verzenden.",
      dictationAudioUnsupported:
        "De Gateway retourneerde een niet-ondersteund audioformaat voor dicteren.",
      dictationBrowserAudioUnsupported: "Deze browser kan geen dicteeraudio op 8 kHz opnemen.",
      ...
      dictationReleaseToInsert: "Loslaten om dictaat in te voegen",
