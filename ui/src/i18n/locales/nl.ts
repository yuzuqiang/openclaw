...
export const nl: TranslationMap = {
  ...
  newSession: {
    ...
    runsOn: "Wordt uitgevoerd op {place}",
  ...
  sessionsView: {
    ...
    viewArchived: "Gearchiveerde threads bekijken",
    sessionArchived: "Thread gearchiveerd",
    sessionsArchived: "{count} threads gearchiveerd",
    deleteAllArchived: "Alle gearchiveerde threads verwijderen…",
    deleteAllArchivedConfirm:
      "{count} gearchiveerde threads en de bijbehorende transcripties verwijderen?",
    ...
    waitingForAnswer: "Wachten op je antwoord",
    ...
    cloudWorkerPlacementConflict: "Cloudworker: {state} · 1 werkruimteconflict",
    cloudWorkerPlacementConflicts: "Cloudworker: {state} · {count} werkruimteconflicten",
    cloudWorkerDescendantConflict: "Onderliggende cloudworker: 1 werkruimteconflict",
    cloudWorkerDescendantConflicts: "Onderliggende cloudworkers: {count} werkruimteconflicten",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "Verwerken…",
      profileHint:
        "JPEG, PNG of WebP. Afbeeldingen worden vanuit het midden bijgesneden en verkleind naar 512 px.",
      profileLoadFailed: "Je profiel kon niet worden geladen.",
      profileSaveFailed: "Je profiel kon niet worden opgeslagen.",
  ...
  configView: {
    ...
    syncedHint: "Gesynchroniseerd op al je apparaten via de Gateway.",
    notifications: {
      title: "Pushmeldingen",
      nativeTitle: "Meldingen",
      hint: "Ontvang browser-pushmeldingen van je gateway.",
      nativeHint:
        "Meldingen worden door de OpenClaw-app op deze Mac weergegeven als systeemeigen meldingen.",
      ...
      nativeBlockedHint:
        "Meldingen voor OpenClaw zijn uitgeschakeld in macOS. Sta ze toe via Systeeminstellingen > Meldingen.",
    },
    appearance: {
      theme: "Thema",
  ...
  subtitles: {
    ...
    custodian: "Systeemconfiguratie en -onderhoud.",
    ...
    labs: "Experimentele mogelijkheden voor agents en tools.",
    ...
    advanced: "Alle overige configuratiesecties, plus de editor voor het onbewerkte bestand.",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Uw gids voor systeemconfiguratie",
    subtitleCaretaker: "Systeemconfiguratie en -onderhoud.",
    exitSetup: "Configuratie afsluiten",
    newAgent: "Nieuwe agent",
    hatchDraft: "Word wakker, mijn vriend!",
    placeholder: "Stuur OpenClaw een bericht…",
    sensitivePlaceholder: "Voer een gevoelige waarde in…",
    ...
    history: {
      ...
      invalidEdit: "Deze handmatige wijziging heeft de configuratievalidatie niet doorstaan.",
      opaqueChange:
        "De opmaak of opmerkingen zijn gewijzigd zonder zichtbare wijzigingen in configuratiepaden.",
      sources: {
        systemAgent: "system-agent",
        doctor: "doctor",
        settings: "instellingen",
        cli: "CLI",
        pluginInstall: "installatie van plug-in",
        manualEdit: "handmatige wijziging",
        unknown: "onbekend",
      },
    },
    nudge: {
      configReload: "Opnieuw laden van configuratie gestopt — vraag me wat er is gebeurd",
      channelAuth: "Authenticatie van {channel} werkt niet goed — vraag me wat er is gebeurd",
      channelDisconnected:
        "De verbinding met {channel} is zojuist verbroken — vraag me wat er is gebeurd",
      channelDegraded: "{channel} werkt niet goed — vraag me wat er is gebeurd",
  ...
  mcpPage: {
    connectorsLink: "Ontdek connectors die u met één klik kunt instellen op de pagina Plug-ins.",
    servers: "Servers",
    oauth: "OAuth",
    filtered: "Gefilterd",
  ...
  labsPage: {
    intro:
      "Labs bevat experimentele mogelijkheden die tussen releases kunnen veranderen, niet meer werken of verdwijnen.",
    sectionTitle: "Experimentele functies",
    sectionDescription:
      "Wijzigingen worden direct opgeslagen en gelden voor toekomstige agentuitvoeringen.",
    documentation: "Documentatie",
    restartRequired: "Herstart van Gateway vereist.",
    saveErrorTitle: "Kan functie niet bijwerken",
    saveFailed: "De functie-instelling kon niet worden opgeslagen.",
    codeMode: {
      title: "Codemodus",
      description: "Laat agents tools combineren in compacte, geïsoleerde JavaScript-workflows.",
    },
    swarm: {
      title: "Zwerm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Bijbehorende apps voor uw telefoon, horloge, desktop en browser — plus plug-ins om de mogelijkheden van uw agent uit te breiden.",
    sectionMobile: "Op uw telefoon",
    havePhone: "Heb je de app al?",
    pairDevice: "Koppel je apparaat",
    sectionWatch: "Om uw pols",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chat, praat, keur acties goed en deel vanuit iOS met OpenClaw.",
      },
      android: {
        title: "Android",
        desc: "Je Android-telefoon als volwaardig OpenClaw-knooppunt — met chat, camera en Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats in één oogopslag en snelle antwoorden vanaf je pols.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Menubalkcompanion voor je Gateway — meldingen, goedkeuringen en snelle chats.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Native desktop-app — beschikbaar als .deb en AppImage.",
      },
      chrome: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      loading: "Je identiteit wordt geladen…",
      ...
      openSettings: "Identiteitsinstellingen voor {name} openen",
      avatarErrors: {
        invalid: "Die afbeelding kon niet worden verwerkt.",
        sourceTooLarge: "Kies een afbeelding van maximaal 10 MB.",
  ...
  gatewayLogs: {
    title: "Logboeken",
    subtitle: "Bestandslogboeken van Gateway (JSONL).",
    ...
    autoFollow: "Automatisch volgen",
    file: "Bestand: {file}",
    truncated: "Loguitvoer afgekapt; het meest recente deel wordt weergegeven.",
  ...
  board: {
    ...
    emptyTitle: "Een leeg dashboard, klaar voor gebruik",
    emptyHint: "Je agent kan hier widgets vastmaken — vraag bijvoorbeeld om een statuskaart.",
    ...
    announcement: {
      ...
      granted: "Toegang tot widget toegestaan.",
      rejected: "Toegang tot widget geweigerd.",
    },
    widget: {
      cellLabel:
      ...
      moveHandle: "Verplaats {title}",
      resizeHandle: "Wijzig de grootte van {title}",
      menuLabel: "Widgetopties",
      moveToTab: "Verplaats naar tabblad",
      ...
      actionErrorDetail: "Het dashboard heeft de vorige status van de widget behouden.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Nog geen dashboard — de werkende agent kan widgets vastmaken.",
    openSession: "Sessie openen",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Gekopieerd",
      branches: "Gesprekstakken",
      branchSwitchUnavailable: "Wisselen van branch is niet beschikbaar terwijl de agent bezig is.",
      branchSwitchRequiresAdmin:
        "Voor het wisselen van branch is beheerderstoegang voor operators vereist.",
      untitledBranch: "Naamloze branch",
      oneMessage: "{count} bericht",
      messages: "{count} berichten",
      activeBranch: "Actieve branch",
    },
    board: {
      faceLabel: "Thread-weergave",
      chatFace: "Chat",
      dashboardFace: "Dashboard",
      dockMenu: "Chatdok: {dock}",
      ...
      resizeDock: "Formaat van chatdok wijzigen",
      reopenChat: "Chat weergeven",
      workboardCard: "Werkbordkaart: {title}, {status}",
      defaultTab: "Hoofd",
      mockPlaceholder: "Naad in bordweergave · {tabs} tabbladen · {widgets} widgets",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw heeft je lokale versies behouden en de overige wijzigingen uit de cloud toegepast. Controleer het voorbereide resultaat of neem de cloudversie over voor een pad met een conflict.",
      morePaths: "+{count} meer paden",
      stagedResult: "Voorbereid cloudresultaat",
      copyStagedResult: "Referentie van voorbereid resultaat kopiëren",
      inspectCloud: "De eerste cloudversie controleren",
      takeCloud: "De eerste cloudversie overnemen",
      copyInspectCommand: "Opdracht voor cloudcontrole kopiëren",
      copyTakeCommand: "Opdracht voor overnemen uit cloud kopiëren",
      commandHelp:
        "Voer deze uit in Bash of zsh (Git Bash op Windows). Als de controle meldt dat het pad niet bestaat, heeft de cloud het verwijderd; controleer dit en verwijder het lokale pad handmatig. Als checkout een bestands-/mapconflict meldt, verplaats of verwijder dan het blokkerende lokale pad en probeer het opnieuw. Als de voorbereide referentie ontbreekt, is de melding verouderd; wijzig het lokale pad niet.",
      commandsUnavailable:
        "Deze bestandsnaam bevat terminalbesturingstekens, waardoor OpenClaw er geen kopieerbare shellopdracht voor maakt. Controleer de voorbereide referentie rechtstreeks en voer het pad handmatig en zorgvuldig in.",
      dismiss: "Melding over conflict in werkruimte sluiten",
      ...
      eventDescription:
        "Lokale versies zijn behouden voor deze paden; andere wijzigingen in de cloud zijn toegepast.",
    },
    compaction: {
    ...
    messages: {
      ...
      rewind: "Terugspoelen",
      rewindConfirm: "Terugspoelen tot vóór dit bericht?",
      rewindToHere: "Tot hier terugspoelen",
      rewindUnavailable: "Terugspoelen is niet beschikbaar terwijl de agent bezig is",
      forkUnavailable: "Afsplitsen is niet beschikbaar terwijl de agent bezig is",
    ...
    modelControls: {
      ...
      usingDefault: "Gebruikt de standaardinstelling uit Instellingen",
    ...
    composer: {
      ...
      cameraAccessFailed: "Kan geen toegang krijgen tot de camera.",
      cameraBusy: "De camera is bezet of niet beschikbaar voor de browser.",
      cameraFallback: "Camera {number}",
      cameraInput: "Camera",
      cameraListUnsupported: "Deze browser kan geen lijst met camera's weergeven.",
      cameraNoneFound: "Geen camera gevonden.",
      cameraPageInactive: "Camera's zijn niet beschikbaar zolang deze pagina inactief is.",
      ...
      holdToRecordSettingDescription:
        "Houd de microfoonknop in het invoerveld ingedrukt, spreek en laat de knop los om tekst in te voegen zonder deze te verzenden.",
      dictationAudioUnsupported:
        "De Gateway heeft een niet-ondersteunde audio-indeling voor dicteren geretourneerd.",
      dictationBrowserAudioUnsupported:
        "Deze browser kan geen audio voor dicteren opnemen met 8 kHz.",
      dictationConnecting: "Dicteren starten…",
      dictationDisconnected:
        "Het dicteren is gestopt omdat de verbinding met de Gateway is verbroken.",
      dictationFailed: "Dicteren is mislukt.",
      dictationFinalizing: "Dicteren afronden…",
      dictationFinalizationTimedOut:
        "Het dicteren is gestopt voordat het laatste gedeeltelijke transcript kon worden afgerond.",
      dictationProviderUnavailable: "Er is geen transcriptieprovider geconfigureerd voor dicteren.",
      dictationRecording: "Opname {elapsed}",
      dictationReleaseToInsert: "Laat los om de gedicteerde tekst in te voegen",
      ...
      switchCamera: "Van camera wisselen",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Deze widget moet opnieuw worden gerenderd om als afbeelding te kunnen worden geëxporteerd.",
      widgetExportFailed: "Het exporteren van de widget is mislukt. Probeer het opnieuw.",
