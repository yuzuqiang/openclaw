...
export const es: TranslationMap = {
  ...
  newSession: {
    ...
    gitCheckUnavailable:
      "No se pudo verificar Git para esta carpeta. Vuelve a elegirla para reintentarlo.",
  ...
  sessionsView: {
    ...
    cloudWorkerPlacementConflict:
      "Trabajador en la nube: {state} · 1 conflicto de espacio de trabajo",
    cloudWorkerPlacementConflicts:
      "Trabajador en la nube: {state} · {count} conflictos de espacios de trabajo",
    cloudWorkerDescendantConflict:
      "Proceso secundario del trabajador en la nube: 1 conflicto de espacio de trabajo",
    cloudWorkerDescendantConflicts:
      "Procesos secundarios del trabajador en la nube: {count} conflictos de espacios de trabajo",
  ...
  configView: {
    ...
    sessionObserver: {
      ...
      hint: "Resume las sesiones de larga duración con un modelo auxiliar pequeño.",
      toggle: "Observador de sesiones",
      toggleHint:
        "Genera resúmenes de estado en tiempo real para las sesiones suscritas de Control UI.",
      resolvedModel: "Modelo pequeño seleccionado",
      modelAuto: "automático ({model})",
      modelConfigured: "configurado ({model})",
      modelDisabled: "deshabilitado",
      modelUnavailable: "no disponible (no hay ningún modelo pequeño)",
      modelPicker: "Modelo pequeño",
      modelPickerHint: "Se usa para los resúmenes del observador y otras tareas auxiliares breves.",
      modelCatalogUnavailable: "El catálogo de modelos explícito no está disponible",
      auto: "Automático (valor predeterminado del proveedor)",
      disabled: "Desactivado",
      toggleNote: "Actualiza el observador de sesiones de Control UI",
      modelNote: "Actualiza el modelo auxiliar predeterminado",
    },
    connection: {
      title: "Conexión",
      gateway: "Gateway",
  ...
  gatewayLogs: {
    title: "Registros",
    subtitle: "Registros de archivos del Gateway (JSONL).",
    ...
    autoFollow: "Seguimiento automático",
    file: "Archivo: {file}",
    truncated: "La salida del registro se ha truncado; se muestra el fragmento más reciente.",
  ...
  board: {
    ...
    widget: {
      ...
      sandboxOriginRequired:
        "La autorización del widget falló tras varios intentos de actualización. Si el Gateway se ejecuta detrás de un proxy inverso o un túnel que no enruta el puerto del entorno aislado del widget, configura mcp.apps.sandboxOrigin con un origen público dedicado que se enrute al listener del entorno aislado.",
      ...
      kindHtml: "HTML",
      kindPlugin: "Plugin",
      pluginLoading: "Cargando el widget del plugin…",
      disabledPlugin: "Widget del plugin deshabilitado {pluginId}",
    },
  },
  workboard: {
    widget: {
      cardLabel: "Tarjeta del tablero de trabajo",
      summaryLabel: "Resumen del tablero de trabajo",
      loading: "Cargando el tablero de trabajo…",
      cardIdRequired: "Este widget necesita una propiedad cardId.",
      cardMissing: "Esta tarjeta del tablero de trabajo ya no está disponible.",
      unassigned: "Sin asignar",
      openBoard: "Abrir tablero",
      statusCounts: "Tarjetas por estado",
      noActiveCards: "No hay tarjetas listas ni en ejecución.",
    },
    ...
    dashboardEmpty: "Aún no hay ningún panel — el agente activo puede fijar widgets.",
    openSession: "Abrir sesión",
  ...
  chat: {
    ...
    waitingForApproval: "Esperando aprobación…",
    startupStatus: {
      preparingWorkspace: "Preparando el espacio de trabajo…",
      provisioningEnvironment: "Aprovisionando el entorno…",
    ...
    board: {
      ...
      workboardCard: "Tarjeta del tablero de trabajo: {title}, {status}",
    ...
    workspaceConflict: {
      titleOne: "1 conflicto en el espacio de trabajo en la nube",
      titleMany: "{count} conflictos en el espacio de trabajo en la nube",
      description:
        "OpenClaw conservó tus versiones locales y aplicó los demás cambios de la nube. Inspecciona el resultado preparado o adopta la versión de la nube para una ruta con conflictos.",
      morePaths: "+{count} rutas más",
      stagedResult: "Resultado de la nube preparado",
      copyStagedResult: "Copiar referencia del resultado preparado",
      inspectCloud: "Inspeccionar la primera versión de la nube",
      takeCloud: "Adoptar la primera versión de la nube",
      copyInspectCommand: "Copiar comando para inspeccionar la nube",
      copyTakeCommand: "Copiar comando para adoptar la versión de la nube",
      commandHelp:
        "Ejecuta estos comandos en Bash o zsh (Git Bash en Windows). Si la inspección indica que la ruta no existe, la nube la eliminó; compruébalo y elimina manualmente la ruta local. Si checkout informa de un conflicto entre un archivo y un directorio, mueve o elimina la ruta local que lo bloquea y vuelve a intentarlo. Si falta la referencia preparada, el aviso está obsoleto; no modifiques la ruta local.",
      commandsUnavailable:
        "Este nombre de archivo contiene caracteres de control del terminal, por lo que OpenClaw no generará un comando de shell que se pueda copiar. Inspecciona directamente la referencia preparada e introduce manualmente la ruta con cuidado.",
      ...
      eventDescription:
        "Se conservaron las versiones locales de estas rutas; se aplicaron los demás cambios de la nube.",
    },
    compaction: {
    ...
    observer: {
      title: "Observador de la sesión",
      expand: "Expandir el observador de la sesión",
      collapse: "Contraer el observador de la sesión",
      plan: "Plan",
      progress: "{completed} de {total}",
      pullRequests: "Solicitudes de incorporación de cambios",
      running: "En ejecución",
      checksPassing: "{count} superadas",
      checksFailing: "{count} con errores",
      checksPending: "{count} en curso",
      askLabel: "Preguntar sobre esta sesión",
      askPlaceholder: "¿Por qué está haciendo eso?",
      askSubmit: "Preguntar",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Script",
      readOnlyPayloadHelp:
        "Este payload se creó fuera de Control UI. Su contenido permanece en modo de solo lectura y se conserva cuando guardas otros cambios.",
