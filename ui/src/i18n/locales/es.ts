...
export const es: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Las notificaciones están deshabilitadas para OpenClaw en macOS. Permítelas en Ajustes del Sistema > Notificaciones.",
    },
    appearance: {
      theme: "Tema",
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Muestra la última actividad del asistente o de la herramienta debajo de las sesiones en ejecución.",
    },
    sessionObserver: {
      ...
      toggleHint: "Genera resúmenes de estado en vivo para las sesiones suscritas de Control UI.",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange:
        "El formato o los comentarios cambiaron sin cambios visibles en la ruta de configuración.",
      sources: {
        systemAgent: "system-agent",
        doctor: "doctor",
        settings: "configuración",
        cli: "CLI",
        pluginInstall: "instalación de complemento",
    ...
    nudge: {
      ...
      channelAuth: "La autenticación de {channel} se ha degradado: pregúntame qué pasó",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        ...
        tooLarge: "El avatar procesado es mayor que 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    announcement: {
      moved: "{title} movido.",
      resized: "Tamaño de {title} cambiado.",
    ...
    widget: {
      ...
      kindHtml: "HTML",
      kindPlugin: "Plugin",
      pluginLoading: "Cargando widget del plugin…",
  ...
  workboard: {
    widget: {
      ...
      cardIdRequired: "Este widget necesita una prop cardId.",
  ...
  chat: {
    ...
    board: {
      ...
      resetTitle: "¿Restablecer conversación?",
      resetDescription: "El contexto de la conversación se restablece. Tu panel permanece.",
    },
    catalog: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Mantén pulsado el botón del micrófono del compositor, habla y luego suelta para insertar texto sin enviarlo.",
      ...
      dictationFinalizing: "Terminando dictado…",
    ...
    toolCards: {
      ...
      widgetExportFailed: "La exportación del widget falló. Inténtalo de nuevo.",
    ...
    sessionDiscussion: {
      ...
      openExternal: "Abrir el debate en una pestaña nueva",
      frameTitle: "Debate de la sesión",
      unavailable: "Esta conversación no se puede insertar.",
    },
    workspaceFiles: {
