...
export const ko: TranslationMap = {
  ...
  newSession: {
    ...
    gitCheckUnavailable:
      "이 폴더에서 Git을 확인할 수 없습니다. 다시 시도하려면 폴더를 다시 선택하세요.",
  ...
  sessionsView: {
    ...
    cloudWorkerDescendantConflict: "클라우드 워커 하위 항목: 워크스페이스 충돌 1건",
    cloudWorkerDescendantConflicts: "클라우드 워커 하위 항목: 워크스페이스 충돌 {count}건",
  ...
  configView: {
    ...
    sessionObserver: {
      title: "세션 관찰자",
      hint: "소형 유틸리티 모델을 사용하여 장시간 실행되는 세션을 요약합니다.",
      toggle: "세션 관찰자",
      toggleHint: "구독 중인 Control UI 세션의 실시간 상태 요약을 생성합니다.",
      resolvedModel: "확정된 소형 모델",
      modelAuto: "자동 ({model})",
      modelConfigured: "구성됨 ({model})",
      modelDisabled: "비활성화됨",
      modelUnavailable: "사용할 수 없음 (소형 모델 없음)",
      modelPicker: "소형 모델",
  ...
  workboard: {
    widget: {
      ...
      loading: "Workboard 불러오는 중…",
      cardIdRequired: "이 위젯에는 cardId prop이 필요합니다.",
      cardMissing: "이 Workboard 카드는 더 이상 사용할 수 없습니다.",
      unassigned: "할당되지 않음",
      openBoard: "보드 열기",
      statusCounts: "상태별 카드",
      noActiveCards: "준비 중이거나 실행 중인 카드가 없습니다.",
    },
  ...
  chat: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw가 로컬 버전을 유지하고 다른 클라우드 변경 사항을 적용했습니다. 스테이징된 결과를 검토하거나 충돌한 경로에 클라우드 버전을 적용하세요.",
      morePaths: "경로 +{count}개 더 보기",
      stagedResult: "스테이징된 클라우드 결과",
      copyStagedResult: "스테이징된 결과 참조 복사",
      inspectCloud: "첫 번째 클라우드 버전 검토",
      takeCloud: "첫 번째 클라우드 버전 적용",
      copyInspectCommand: "클라우드 검토 명령어 복사",
      copyTakeCommand: "클라우드 버전 적용 명령어 복사",
      commandHelp:
        "Bash 또는 zsh(Windows에서는 Git Bash)에서 이 명령어를 실행하세요. 검토 결과 경로가 존재하지 않는다고 표시되면 클라우드에서 해당 경로를 삭제한 것입니다. 이를 확인한 후 로컬 경로를 수동으로 삭제하세요. checkout에서 파일/디렉터리 충돌이 보고되면 방해가 되는 로컬 경로를 이동하거나 삭제한 후 다시 시도하세요. 스테이징된 참조가 없으면 이 알림은 오래된 것입니다. 로컬 경로를 변경하지 마세요.",
      commandsUnavailable:
        "이 파일 이름에 터미널 제어 문자가 포함되어 있어 OpenClaw가 복사 가능한 셸 명령어를 생성하지 않습니다. 스테이징된 참조를 직접 검토하고 주의해서 경로를 수동으로 입력하세요.",
      dismiss: "워크스페이스 충돌 알림 닫기",
      eventSender: "클라우드 워크스페이스",
      eventTitleOne: "클라우드 결과가 충돌 1건과 함께 적용됨",
      eventTitleMany: "클라우드 결과가 충돌 {count}건과 함께 적용됨",
      eventDescription:
    ...
    observer: {
      ...
      askLabel: "이 세션에 관해 질문",
      askPlaceholder: "왜 이렇게 작동하나요?",
      askSubmit: "확인",
      askPending: "관찰 결과를 확인하는 중…",
      askBusy: "관찰자가 이미 질문에 답변하고 있습니다.",
      askUnavailable: "현재 관찰자가 답변할 수 없습니다.",
      health: {
        "on-track": "정상 진행 중",
        grinding: "작업 중",
        stuck: "막힘",
        "waiting-on-user": "사용자 응답 대기 중",
        "wrapping-up": "마무리 중",
        done: "완료",
        failed: "실패",
      },
  ...
  cron: {
    ...
    form: {
      ...
      script: "스크립트",
      readOnlyPayloadHelp:
        "이 페이로드는 Control UI 외부에서 생성되었습니다. 내용은 읽기 전용으로 유지되며 다른 변경 사항을 저장해도 보존됩니다.",
