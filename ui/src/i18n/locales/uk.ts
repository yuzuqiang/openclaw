...
export const uk: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Збережену сесію WhatsApp не було очищено. Можливо, вона вже відсутня, або її каталог автентифікації потребує ручного очищення.",
    },
  ...
  newSession: {
    ...
    gitCheckUnavailable:
      "Не вдалося перевірити Git для цієї теки. Оберіть її знову, щоб повторити спробу.",
  ...
  sessionsView: {
    ...
    sessionArchived: "Тред заархівовано",
    sessionsArchived: "Заархівовано {count} тредів",
    deleteAllArchived: "Видалити всі заархівовані…",
    deleteAllArchivedConfirm: "Видалити {count} заархівованих тредів і їхні транскрипти?",
    ...
    waitingForAnswer: "Очікує вашої відповіді",
    waitingForApproval: "Очікує схвалення",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Сповіщення відображаються нативно застосунком OpenClaw на цьому Mac.",
    ...
    sidebarPrefs: {
      title: "Бічна панель",
      hint: "Виберіть, що відображатиметься під час активних сесій.",
      liveActivity: "Показувати активність агента в бічній панелі",
      liveActivityHint:
        "Показувати останню активність асистента або інструмента під активними сесіями.",
    },
    sessionObserver: {
      title: "Спостерігач сесій",
      hint: "Створюйте зведення тривалих сесій за допомогою невеликої допоміжної моделі.",
      ...
      auto: "Авто (стандартний варіант провайдера)",
      disabled: "Вимкнено",
      toggleNote: "Оновити спостерігач сесій Control UI",
      modelNote: "Оновити стандартну допоміжну модель",
    },
    connection: {
      title: "Підключення",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange: "Форматування чи коментарі змінилися без видимих змін шляхів конфігурації.",
      sources: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel} у стані погіршення — запитайте мене, що сталося",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Режим коду",
      description:
        "Дозвольте агентам поєднувати інструменти у компактних ізольованих JavaScript-процесах.",
    },
    swarm: {
      title: "Рій",
  ...
  appsPage: {
    heroTitle: "Беріть OpenClaw усюди з собою",
    heroTagline:
      "Супутні застосунки для телефона, годинника, комп’ютера й браузера — а також плагіни, що розширюють можливості вашого агента.",
    sectionMobile: "На телефоні",
    havePhone: "Уже маєте застосунок?",
    pairDevice: "Спаруйте свій пристрій",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Спілкуйтеся, розмовляйте, схвалюйте дії та діліться контентом з OpenClaw на iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Швидкий перегляд чатів і швидкі відповіді просто з зап'ястя.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Супутній застосунок Android розширює OpenClaw до вашого годинника.",
      },
      macos: {
        title: "macOS",
        desc: "Супутник у рядку меню для вашого Gateway — сповіщення, схвалення, швидкий чат.",
      },
      windows: {
        title: "Windows",
        desc: "Супутній застосунок Windows підключає ваш ПК як вузол OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  gatewayLogs: {
    ...
    filter: "Фільтр",
    searchPlaceholder: "Шукати в журналах",
    autoFollow: "Автоперехід",
    file: "Файл: {file}",
  ...
  board: {
    ...
    emptyHint: "Ваш агент може закріплювати тут віджети — спробуйте попросити картку статусу.",
    actionFailed: "Не вдалося зберегти зміни панелі.",
    actionInProgress: "Ще зберігається інша зміна дашборда.",
    announcement: {
    ...
    widget: {
      cellLabel:
        "Віджет дашборда: {title}. Використовуйте клавіші зі стрілками для навігації. Утримуйте Alt і натисніть клавішу зі стрілкою, щоб перемістити його.",
      ...
      appStaleDetail: "Його сервер, ресурс або початкова стенограма більше недоступні.",
      retry: "Повторити",
      ...
      sandboxOriginRequired:
        "Не вдалося авторизувати віджет після кількох спроб оновлення. Якщо gateway працює за зворотним проксі або тунелем, який не маршрутизує порт пісочниці віджета, встановіть mcp.apps.sandboxOrigin на окреме публічне джерело, маршрутизоване до слухача пісочниці.",
  ...
  workboard: {
    widget: {
      ...
      noActiveCards: "Немає готових або виконуваних карток.",
    },
  ...
  chat: {
    ...
    board: {
      ...
      defaultTab: "Головна",
      mockPlaceholder: "Вигляд дошки · {tabs} вкладок · {widgets} віджетів",
      mockOverview: "Огляд",
      ...
      resetDescription: "Контекст розмови скидається. Ваша інформаційна панель залишається.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      titleMany: "Конфліктів хмарного робочого простору: {count}",
      description:
      ...
      copyStagedResult: "Копіювати посилання підготовленого результату",
      ...
      commandHelp:
        "Виконуйте їх у Bash або zsh (Git Bash на Windows). Якщо перевірка повідомляє, що шлях не існує, хмара його видалила; перевірте та видаліть локальний шлях вручну. Якщо checkout повідомляє про конфлікт файлу/каталогу, перемістіть або видаліть блокуючий локальний шлях, а потім повторіть спробу. Якщо підготовлене посилання відсутнє, повідомлення застаріле; не змінюйте локальний шлях.",
      commandsUnavailable:
        "Ця назва файлу містить керуючі символи терміналу, тому OpenClaw не створюватиме для неї команду оболонки, яку можна скопіювати. Перевірте підготовлене посилання безпосередньо та обережно введіть шлях вручну.",
    ...
    composer: {
      ...
      cameraInput: "Камера",
      cameraListUnsupported: "Цей браузер не може отримати список камер.",
      ...
      microphoneAppliesNextSession: "Зміни застосуються, коли ви розпочнете наступний сеанс Talk.",
      ...
      holdToRecordSettingDescription:
        "Утримуйте кнопку мікрофона в полі введення, говоріть, а потім відпустіть, щоб вставити текст без надсилання.",
      ...
      dictationFinalizationTimedOut:
        "Диктування зупинено до того, як останній частковий транскрипт міг бути фіналізований.",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Щоб експортувати цей віджет як зображення, його потрібно повторно відрендерити.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Скрипт",
      readOnlyPayloadHelp:
        "Цей payload було створено поза Control UI. Його вміст залишається доступним лише для читання та зберігається під час збереження інших змін.",
