...
export const uk: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Для хмарних виконавців потрібне середовище виконання OpenClaw; вибрано {runtime}.",
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "Видалити {count} архівованих гілок та їхні стенограми?",
    ...
    dashboardAvailable: "Панель керування доступна",
    ...
    waitingForAnswer: "Очікування на вашу відповідь",
    waitingForApproval: "Очікування на схвалення",
    runFailedReason: "Не вдалося виконати: {reason}",
    ...
    cloudWorkerPlacementConflict: "Хмарний виконавець: {state} · 1 конфлікт робочого простору",
    cloudWorkerPlacementConflicts:
      "Хмарний виконавець: {state} · конфліктів робочого простору: {count}",
    cloudWorkerDescendantConflict: "Дочірній хмарний виконавець: 1 конфлікт робочого простору",
    cloudWorkerDescendantConflicts:
      "Дочірні хмарні виконавці: конфліктів робочого простору: {count}",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "Обробка…",
      profileHint:
        "JPEG, PNG або WebP. Зображення обрізаються по центру та змінюють розмір до 512 пікселів.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Сповіщення відображаються безпосередньо застосунком OpenClaw на цьому Mac.",
      ...
      nativeBlockedHint:
        "Сповіщення для OpenClaw вимкнено в macOS. Дозвольте їх у меню «Системні параметри» > «Сповіщення».",
    },
    appearance: {
      theme: "Тема",
    ...
    sidebarPrefs: {
      title: "Бічна панель",
      hint: "Виберіть, що відображатиметься під час активних сеансів.",
      liveActivity: "Показувати активність агента в реальному часі на бічній панелі",
      liveActivityHint:
  ...
  execApproval: {
    ...
    otherPending: "Інші запити, що очікують",
    reviewRequest: "Переглянути запит на схвалення від {agent}: {command}",
  ...
  subtitles: {
    ...
    custodian: "Налаштування системи та догляд за нею.",
    ...
    labs: "Експериментальні можливості агентів та інструментів.",
    ...
    notifications: "Push-сповіщення в браузері від вашого gateway.",
    security: "Автентифікація Gateway, політика виконання, профіль інструментів і схвалення.",
    advanced: "Усі інші розділи конфігурації, а також редактор вихідного файлу.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Налаштування системи та догляд за нею.",
    exitSetup: "Вийти з налаштування",
    newAgent: "Новий агент",
    hatchDraft: "Прокидайся, друже!",
    placeholder: "Напишіть OpenClaw…",
    ...
    history: {
      button: "Історія",
      title: "Останні зміни",
      description: "Що змінилося в цій системі, від найновіших змін.",
      loading: "Завантаження останніх змін…",
      empty: "Записаних змін ще немає.",
      requestFailed: "OpenClaw не вдалося завантажити історію змін.",
      loadMore: "Завантажити ще",
      loadingMore: "Завантаження додаткових даних…",
      ...
      sources: {
        ...
        settings: "налаштування",
        cli: "CLI",
        pluginInstall: "встановлення плагіна",
    ...
    nudge: {
      ...
      channelAuth: "Автентифікація {channel} працює неналежно — запитайте мене, що сталося",
      channelDisconnected: "{channel} щойно відключено — запитайте мене, що сталося",
      channelDegraded: "{channel} працює неналежно — запитайте мене, що сталося",
  ...
  mcpServers: {
    ...
    targetInvalid: "Введіть URL-адресу http(s) або командний рядок.",
    nameTaken: "Сервер MCP з іменем «{name}» уже існує.",
    missing: "Сервер MCP «{name}» не знайдено в конфігурації.",
    missingTransport: "відсутній транспорт",
    addedSuccess: "Сервер MCP {name} додано.",
    enabledSuccess: "Сервер MCP {name} увімкнено.",
    disabledSuccess: "Сервер MCP {name} вимкнено.",
    removedSuccess: "Сервер MCP {name} видалено.",
    configUnavailable: "Конфігурація недоступна; оновіть сторінку та повторіть спробу.",
    connectRequired: "Підключіться до Gateway, щоб змінити сервери MCP.",
    adminRequired: "Для змін серверів MCP потрібен доступ operator.admin.",
    enable: "Увімкніть",
    disable: "Вимкнути",
  ...
  mcpPage: {
    connectorsLink: "Знайдіть конектори з підключенням одним натисканням на сторінці плагінів.",
    servers: "Сервери",
    oauth: "OAuth",
  ...
  sessionsPage: {
    hubTablistLabel: "Розділи сеансів",
  },
  pluginsPage: {
  ...
  labsPage: {
    ...
    sectionDescription:
      "Зміни зберігаються негайно та застосовуються до майбутніх запусків агентів.",
  ...
  appsPage: {
    heroTitle: "Беріть OpenClaw із собою всюди",
    heroTagline:
      "Застосунки-компаньйони для телефона, годинника, комп’ютера та браузера, а також плагіни для розширення можливостей вашого агента.",
    sectionMobile: "На телефоні",
    havePhone: "Уже маєте застосунок?",
    pairDevice: "З’єднати пристрій",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Спілкуйтеся в чаті й голосом, схвалюйте дії та діліться вмістом з OpenClaw на iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Швидкий перегляд чатів і короткі відповіді із зап’ястка.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Супутній застосунок для Android поширює можливості OpenClaw на ваш годинник.",
      },
      macos: {
        title: "macOS",
        desc: "Супутній застосунок у рядку меню для вашого Gateway — сповіщення, підтвердження та швидкий чат.",
      },
      windows: {
        title: "Windows",
        desc: "Супутній застосунок для Windows підключає ваш ПК як вузол OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Нативний настільний застосунок — збірки .deb та AppImage.",
      },
      chrome: {
  ...
  presence: {
    rosterLabel: "Показати, хто в мережі",
    rosterTitle: "У мережі",
    you: "ви",
  },
  profilePage: {
    ...
    identity: {
      ...
      loading: "Завантаження даних про вашу ідентичність…",
      profileUnavailable: "Не вдалося завантажити ваш профіль ідентичності.",
      notSet: "Ідентичність не задано.",
      setIdentity: "Задати ідентичність",
      avatar: "Аватар",
      avatarDescription:
        "PNG, JPEG або WebP. Розмір зображень буде змінено до 256 × 256 або менше.",
      chooseAvatar: "Вибрати зображення",
      processingAvatar: "Обробка…",
      displayName: "Ім’я для відображення",
      displayNameDescription: "Відображається іншим користувачам цього Gateway.",
      linkedEmails: "Пов’язані адреси електронної пошти",
      linkedEmailsDescription: "Адреси електронної пошти, пов’язані з цим профілем.",
      openSettings: "Відкрити налаштування ідентичності для {name}",
      avatarErrors: {
        invalid: "Не вдалося обробити це зображення.",
        sourceTooLarge: "Виберіть зображення розміром не більше 10 МБ.",
        tooLarge: "Оброблений аватар має розмір понад 512 КБ.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    ...
    autoFollow: "Автоматичне відстеження",
    file: "Файл: {file}",
    truncated: "Виведення журналу скорочено; показано останній фрагмент.",
    empty: "Записів у журналі немає.",
  },
  pluginTabs: {
  ...
  board: {
    ...
    tabsLabel: "Вкладки панелі керування",
    moreTabs: "Інші вкладки панелі керування",
    gridLabel: "Віджети панелі керування",
    emptyTitle: "Чиста дошка, готова до роботи",
    emptyHint: "Ваш агент може закріплювати тут віджети — спробуйте попросити картку стану.",
    actionFailed: "Не вдалося зберегти зміну панелі керування.",
    actionInProgress: "Інша зміна панелі керування все ще зберігається.",
    announcement: {
    ...
    widget: {
      cellLabel:
        "Віджет панелі керування: {title}. Використовуйте клавіші зі стрілками для навігації. Утримуйте Alt і натисніть клавішу зі стрілкою, щоб перемістити його.",
      moveHandle: "Перемістити {title}",
      resizeHandle: "Змінити розмір {title}",
      menuLabel: "Параметри віджета",
      moveToTab: "Перемістити на вкладку",
      noOtherTabs: "Інших вкладок немає",
      ...
      actionErrorDetail: "На панелі керування збережено попередній стан віджета.",
  ...
  chat: {
    ...
    board: {
      faceLabel: "Вигляд обговорення",
      chatFace: "Чат",
      dashboardFace: "Панель керування",
      dockMenu: "Закріплення чату: {dock}",
      dockLeft: "Закріпити чат ліворуч",
      dockRight: "Закріпити чат праворуч",
      dockBottom: "Закріпити чат унизу",
      dockHidden: "Приховати чат",
      resizeDock: "Змінити розмір закріпленої області чату",
      reopenChat: "Показати чат",
      workboardCard: "Картка робочої дошки: {title}, {status}",
      defaultTab: "Головна",
      mockPlaceholder: "Область подання дошки · вкладок: {tabs} · віджетів: {widgets}",
      mockOverview: "Огляд",
      mockResearch: "Дослідження",
      mockSessionStatus: "Статус гілки",
      mockRecentFindings: "Останні результати",
      mockSourceMap: "Мапа джерел",
      resetTitle: "Скинути розмову?",
      resetDescription: "Контекст розмови буде скинуто. Ваша панель керування залишиться.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw зберіг ваші локальні версії та застосував інші зміни з хмари. Перевірте підготовлений результат або прийміть хмарну версію конфліктного шляху.",
      ...
      takeCloud: "Прийняти першу хмарну версію",
      copyInspectCommand: "Копіювати команду перевірки хмарної версії",
      copyTakeCommand: "Копіювати команду прийняття хмарної версії",
      commandHelp:
        "Виконайте ці команди в Bash або zsh (Git Bash у Windows). Якщо під час перевірки вказано, що шлях не існує, його видалено з хмари; перевірте це та видаліть локальний шлях вручну. Якщо checkout повідомляє про конфлікт файлу/каталогу, перемістіть або видаліть локальний шлях, що перешкоджає виконанню, а потім повторіть спробу. Якщо посилання на підготовлений результат відсутнє, це сповіщення застаріло; не змінюйте локальний шлях.",
      commandsUnavailable:
        "Ця назва файлу містить керівні символи термінала, тому OpenClaw не створюватиме для неї команду оболонки, яку можна скопіювати. Перевірте посилання на підготовлений результат безпосередньо та обережно введіть шлях вручну.",
      ...
      eventDescription: "Для цих шляхів збережено локальні версії; інші зміни з хмари застосовано.",
    },
    compaction: {
    ...
    sidebar: {
      ...
      toolActivity: "Використовується {tool}",
    },
    welcome: {
    ...
    messages: {
      ...
      rewindToHere: "Відмотати до цього місця",
      rewindUnavailable: "Відмотування недоступне, поки агент працює",
    ...
    modelControls: {
      ...
      reasoning: "Міркування",
      speed: "Швидкість",
      sessionOverride: "Перевизначення для сеансу",
      usingDefault: "Використовується значення за замовчуванням із Налаштувань",
      resetToDefault: "Скинути до значення за замовчуванням ({model})",
    },
    sideChat: {
      title: "Бічний чат",
    ...
    composer: {
      ...
      cameraInput: "Камера",
      cameraListUnsupported: "Цей браузер не може відобразити список камер.",
      ...
      microphoneAppliesNextSession: "Зміни буде застосовано на початку наступного сеансу розмови.",
      ...
      holdToRecordSetting: "Утримувати кнопку мікрофона для диктування",
      holdToRecordSettingDescription:
        "Утримуйте кнопку мікрофона в полі введення, говоріть, а потім відпустіть її, щоб вставити текст без надсилання.",
      dictationAudioUnsupported: "Gateway повернув непідтримуваний формат аудіо для диктування.",
      dictationBrowserAudioUnsupported:
        "Цей браузер не може записувати аудіо для диктування з частотою 8 кГц.",
      ...
      dictationFinalizationTimedOut:
        "Диктування зупинено до завершення обробки останньої часткової транскрипції.",
      dictationProviderUnavailable: "Для диктування не налаштовано постачальника транскрипції.",
      dictationRecording: "Запис {elapsed}",
      dictationReleaseToInsert: "Відпустіть, щоб вставити продиктований текст",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Цей віджет потрібно повторно відтворити, щоб експортувати як зображення.",
      widgetExportFailed: "Не вдалося експортувати віджет. Спробуйте ще раз.",
      pinToDashboard: "Закріпити на панелі керування",
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySeconds: "Запускається кожні {amount} с",
