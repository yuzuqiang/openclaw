...
export const de: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Cloud-Worker benötigen die OpenClaw-Laufzeitumgebung; {runtime} ist ausgewählt.",
    ...
    runsOn: "Wird auf {place} ausgeführt",
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "{count} archivierte Threads und deren Transkripte löschen?",
    ...
    waitingForAnswer: "Warten auf Ihre Antwort",
    ...
    cloudWorkerPlacementConflict: "Cloud-Worker: {state} · 1 Arbeitsbereichskonflikt",
    cloudWorkerPlacementConflicts: "Cloud-Worker: {state} · {count} Arbeitsbereichskonflikte",
    cloudWorkerDescendantConflict: "Untergeordneter Cloud-Worker: 1 Arbeitsbereichskonflikt",
    cloudWorkerDescendantConflicts: "Untergeordnete Cloud-Worker: {count} Arbeitsbereichskonflikte",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Dein Gateway-Profil",
      ...
      profileHint:
        "JPEG, PNG oder WebP. Bilder werden mittig zugeschnitten und auf 512 px skaliert.",
      profileLoadFailed: "Dein Profil konnte nicht geladen werden.",
      profileSaveFailed: "Dein Profil konnte nicht gespeichert werden.",
      avatarInvalid: "Wähle ein gültiges JPEG-, PNG- oder WebP-Bild aus.",
  ...
  configView: {
    ...
    syncedHint: "Über das Gateway mit Ihren Geräten synchronisiert.",
    notifications: {
  ...
  execApproval: {
    ...
    reviewRequest: "Genehmigung von {agent} prüfen: {command}",
  ...
  subtitles: {
    ...
    apps: "Begleit-Apps für Smartphone, Smartwatch, Desktop und Browser.",
    ...
    labs: "Experimentelle Agenten- und Tool-Funktionen.",
    ...
    security: "Gateway-Authentifizierung, Ausführungsrichtlinie, Toolprofil und Genehmigungen.",
    advanced: "Alle verbleibenden Konfigurationsabschnitte sowie der Editor für die Rohdatei.",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Die Änderungen an diesem System, neueste zuerst.",
      ...
      opaqueChange:
        "Formatierung oder Kommentare wurden geändert, ohne dass sichtbare Änderungen an Konfigurationspfaden vorgenommen wurden.",
      sources: {
        ...
        manualEdit: "manuelle Änderung",
        unknown: "unbekannt",
      },
    },
    nudge: {
      configReload:
        "Das erneute Laden der Konfiguration wurde angehalten — frag mich, was passiert ist",
      channelAuth:
        "Die Authentifizierung für {channel} ist beeinträchtigt — frag mich, was passiert ist",
      channelDisconnected:
        "Die Verbindung zu {channel} wurde gerade getrennt — frag mich, was passiert ist",
      channelDegraded: "{channel} ist beeinträchtigt — frag mich, was passiert ist",
      channelFallback: "Ein Kanal",
      dismiss: "Dieses Update verwerfen",
    },
  },
  mcpServers: {
    ...
    targetInvalid: "Gib eine http(s)-URL oder eine Befehlszeile ein.",
    nameTaken: "Ein MCP-Server mit dem Namen „{name}“ ist bereits vorhanden.",
    missing: "MCP-Server „{name}“ wurde in der Konfiguration nicht gefunden.",
    missingTransport: "fehlender Transport",
    addedSuccess: "MCP-Server {name} wurde hinzugefügt.",
    enabledSuccess: "MCP-Server {name} wurde aktiviert.",
    disabledSuccess: "MCP-Server {name} wurde deaktiviert.",
    removedSuccess: "MCP-Server {name} wurde entfernt.",
    configUnavailable:
      "Die Konfiguration ist nicht verfügbar; aktualisieren Sie die Seite und versuchen Sie es erneut.",
    connectRequired: "Stellen Sie eine Verbindung zum Gateway her, um MCP-Server zu ändern.",
  ...
  mcpPage: {
    connectorsLink: "Entdecken Sie Konnektoren mit Ein-Klick-Einrichtung auf der Seite „Plugins“.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Gefiltert",
  ...
  labsPage: {
    intro:
      "Labs enthält experimentelle Funktionen, die sich zwischen Versionen ändern, nicht mehr funktionieren oder verschwinden können.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Ermöglicht Agenten, Tools in kompakten, isolierten JavaScript-Workflows zu kombinieren.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    heroTitle: "OpenClaw überall dabei",
    heroTagline:
      "Begleit-Apps für Smartphone, Smartwatch, Desktop und Browser — plus Plugins, die die Fähigkeiten Ihres Agenten erweitern.",
    sectionMobile: "Auf Ihrem Smartphone",
    havePhone: "Haben Sie die App bereits?",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatte, sprich, genehmige Aktionen und teile Inhalte aus iOS mit OpenClaw.",
      },
      android: {
        title: "Android",
        desc: "Dein Android-Smartphone als vollwertiger OpenClaw-Knoten – mit Chat, Kamera und Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats auf einen Blick und schnelle Antworten direkt von deinem Handgelenk.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Die Android-Begleit-App erweitert OpenClaw auf deine Smartwatch.",
      },
      macos: {
        title: "macOS",
        desc: "Menüleisten-Begleit-App für dein Gateway — Benachrichtigungen, Genehmigungen, Schnellchat.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Native Desktop-App — als .deb- und AppImage-Build.",
      },
      chrome: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      notSet: "Die Identität ist nicht festgelegt.",
      ...
      linkedEmails: "Verknüpfte E-Mail-Adressen",
      linkedEmailsDescription: "Mit diesem Profil verknüpfte E-Mail-Adressen.",
      openSettings: "Identitätseinstellungen für {name} öffnen",
      avatarErrors: {
        invalid: "Dieses Bild konnte nicht verarbeitet werden.",
        sourceTooLarge: "Wählen Sie ein Bild aus, das höchstens 10 MB groß ist.",
  ...
  gatewayLogs: {
    ...
    autoFollow: "Automatisch folgen",
    file: "Datei: {file}",
    truncated: "Protokollausgabe gekürzt; der neueste Abschnitt wird angezeigt.",
  ...
  board: {
    ...
    emptyTitle: "Ein übersichtliches Board, bereit für die Arbeit",
    emptyHint:
      "Dein Agent kann hier Widgets anheften – bitte ihn zum Beispiel um eine Statuskarte.",
    ...
    announcement: {
      ...
      resized: "Die Größe von {title} wurde geändert.",
      removed: "{title} wurde entfernt.",
      granted: "Widget-Zugriff wurde erlaubt.",
      rejected: "Widget-Zugriff wurde abgelehnt.",
    },
    widget: {
      cellLabel:
        "Dashboard-Widget: {title}. Verwende die Pfeiltasten zur Navigation. Halte die Alt-Taste gedrückt und drücke eine Pfeiltaste, um es zu verschieben.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Noch kein Dashboard — der Arbeitsagent kann Widgets anheften.",
    openSession: "Sitzung öffnen",
  ...
  chat: {
    ...
    workspaceConflict: {
      titleOne: "1 Konflikt im Cloud-Arbeitsbereich",
      titleMany: "{count} Konflikte im Cloud-Arbeitsbereich",
      description:
        "OpenClaw hat Ihre lokalen Versionen beibehalten und die übrigen Cloud-Änderungen angewendet. Prüfen Sie das bereitgestellte Ergebnis oder übernehmen Sie für einen Pfad mit Konflikt dessen Version.",
      ...
      copyInspectCommand: "Befehl zum Prüfen der Cloud-Version kopieren",
      copyTakeCommand: "Befehl zum Übernehmen der Cloud-Version kopieren",
      commandHelp:
        "Führen Sie diese Befehle in Bash oder zsh aus (Git Bash unter Windows). Wenn die Prüfung meldet, dass der Pfad nicht existiert, wurde er aus der Cloud gelöscht; überprüfen Sie dies und entfernen Sie den lokalen Pfad manuell. Wenn checkout einen Datei-/Verzeichniskonflikt meldet, verschieben oder entfernen Sie den blockierenden lokalen Pfad und versuchen Sie es erneut. Wenn die bereitgestellte Referenz fehlt, ist der Hinweis veraltet; ändern Sie den lokalen Pfad nicht.",
      commandsUnavailable:
        "Dieser Dateiname enthält Terminal-Steuerzeichen. Daher erstellt OpenClaw dafür keinen kopierbaren Shell-Befehl. Prüfen Sie die bereitgestellte Referenz direkt und geben Sie den Pfad sorgfältig manuell ein.",
      dismiss: "Hinweis auf Arbeitsbereichskonflikt schließen",
      eventSender: "Cloud-Arbeitsbereich",
      eventTitleOne: "Cloud-Ergebnis mit 1 Konflikt angewendet",
      eventTitleMany: "Cloud-Ergebnis mit {count} Konflikten angewendet",
      eventDescription:
        "Für diese Pfade wurden die lokalen Versionen beibehalten; andere Änderungen aus der Cloud wurden übernommen.",
    },
    compaction: {
    ...
    turnRecap: {
      doneIn: "Abgeschlossen in {duration}",
      tokens: "{count} Tokens",
      tokensOne: "1 Token",
    },
    commands: {
    ...
    messages: {
      ...
      rewind: "Zurückspulen",
      rewindConfirm: "Bis vor diese Nachricht zurückspulen?",
    ...
    modelControls: {
      ...
      usingDefault: "Standardwert aus den Einstellungen wird verwendet",
      resetToDefault: "Auf Standardwert zurücksetzen ({model})",
    },
    sideChat: {
      title: "Seitenchat",
    ...
    composer: {
      ...
      cameraAccessFailed: "Auf die Kamera kann nicht zugegriffen werden.",
      ...
      cameraPageInactive: "Kameras sind nicht verfügbar, solange diese Seite inaktiv ist.",
      ...
      microphoneAppliesNextSession:
        "Änderungen werden beim Start Ihrer nächsten Talk-Sitzung wirksam.",
      ...
      holdToRecordSettingDescription:
        "Halten Sie die Mikrofontaste im Eingabefeld gedrückt, sprechen Sie und lassen Sie sie dann los, um Text einzufügen, ohne ihn zu senden.",
      dictationAudioUnsupported:
        "Das Gateway hat ein nicht unterstütztes Audioformat für das Diktat zurückgegeben.",
      dictationBrowserAudioUnsupported:
        "Dieser Browser kann Diktataudio nicht mit 8 kHz aufnehmen.",
      dictationConnecting: "Diktat wird gestartet…",
      dictationDisconnected:
        "Das Diktat wurde beendet, weil die Verbindung zum Gateway getrennt wurde.",
      dictationFailed: "Diktat fehlgeschlagen.",
      dictationFinalizing: "Diktat wird abgeschlossen…",
      dictationFinalizationTimedOut:
        "Das Diktat wurde beendet, bevor das letzte Teiltranskript fertiggestellt werden konnte.",
      dictationProviderUnavailable:
        "Für die Diktierfunktion ist kein Transkriptionsanbieter konfiguriert.",
      dictationRecording: "Aufnahme {elapsed}",
      dictationReleaseToInsert: "Loslassen, um das Diktat einzufügen",
      ...
      selectedCameraUnavailable:
        "Die ausgewählte Kamera ist nicht verfügbar. Wählen Sie eine andere Kamera oder den Systemstandard.",
