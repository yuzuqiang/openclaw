...
export const de: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Es wurde keine gespeicherte WhatsApp-Sitzung gelöscht. Möglicherweise ist keine vorhanden, oder das Auth-Verzeichnis muss manuell bereinigt werden.",
    },
  ...
  newSession: {
    ...
    gitCheckUnavailable:
      "Git konnte für diesen Ordner nicht überprüft werden. Wähle ihn erneut aus, um es noch einmal zu versuchen.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Benachrichtigungen sind für OpenClaw in macOS deaktiviert. Erlauben Sie sie unter Systemeinstellungen > Mitteilungen.",
    },
    appearance: {
      theme: "Design",
    ...
    sessionObserver: {
      ...
      hint: "Fassen Sie langlaufende Sitzungen mit einem kleinen Hilfsmodell zusammen.",
      toggle: "Sitzungsbeobachter",
      toggleHint: "Live-Statuszusammenfassungen für abonnierte Control UI-Sitzungen generieren.",
  ...
  execApproval: {
    ...
    otherPending: "Andere ausstehende Anfragen",
  ...
  subtitles: {
    ...
    advanced: "Alle verbleibenden Konfigurationsabschnitte sowie der Rohdatei-Editor.",
  ...
  custodian: {
    ...
    placeholder: "OpenClaw eine Nachricht senden…",
    sensitivePlaceholder: "Sensiblen Wert eingeben…",
    sensitiveReply: "Sensible Antwort gesendet",
    send: "Senden",
    thinking: "OpenClaw denkt nach",
    earlier: "Früher",
    requestFailed: "OpenClaw konnte nicht antworten. Erneut versuchen.",
    connectionChanged:
      "Die Gateway-Verbindung hat sich geändert. Erneut versuchen, um diese Einrichtung fortzusetzen.",
    sessionRestarted:
    ...
    history: {
      ...
      opaqueChange:
        "Formatierung oder Kommentare wurden geändert, ohne sichtbare Änderungen am Konfigurationspfad.",
      sources: {
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Lassen Sie Agenten Tools in kompakten, sandboxed JavaScript-Workflows kombinieren.",
    },
    swarm: {
      title: "Swarm",
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "Anzeigename",
      displayNameDescription: "Wird anderen Personen auf diesem Gateway angezeigt.",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Dashboard-Widget: {title}. Mit den Pfeiltasten navigieren. Halten Sie Alt gedrückt und drücken Sie eine Pfeiltaste, um es zu verschieben.",
      ...
      sandboxUnavailable: "Widget-Sandbox-Host ist nicht verfügbar.",
      ...
      sandboxOriginRequired:
        "Widget-Autorisierung nach wiederholten Aktualisierungsversuchen fehlgeschlagen. Wenn das Gateway hinter einem Reverse-Proxy oder Tunnel läuft, der den Widget-Sandbox-Port nicht weiterleitet, setzen Sie mcp.apps.sandboxOrigin auf einen dedizierten öffentlichen Origin, der an den Sandbox-Listener geroutet wird.",
  ...
  chat: {
    ...
    waitingForApproval: "Warte auf Freigabe…",
    startupStatus: {
    ...
    outputTokens: "{count} Ausgabetokens",
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin:
        "Für den Verzweigungswechsel ist Operator-Administratorzugriff erforderlich.",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw hat deine lokalen Versionen behalten und die anderen Cloud-Änderungen angewendet. Prüfe das bereitgestellte Ergebnis oder übernimm dessen Version für einen konfliktbehafteten Pfad.",
      ...
      commandHelp:
        "Führe diese in Bash oder zsh aus (Git Bash unter Windows). Wenn inspect meldet, dass der Pfad nicht existiert, hat die Cloud ihn gelöscht; überprüfe das und entferne den lokalen Pfad manuell. Wenn checkout einen Datei-/Verzeichniskonflikt meldet, verschiebe oder entferne den blockierenden lokalen Pfad und versuche es erneut. Wenn das bereitgestellte Ref fehlt, ist der Hinweis veraltet; ändere den lokalen Pfad nicht.",
      commandsUnavailable:
        "Dieser Dateiname enthält Terminal-Steuerzeichen, daher erstellt OpenClaw dafür keinen kopierbaren Shell-Befehl. Prüfe das bereitgestellte Ref direkt und gib den Pfad sorgfältig manuell ein.",
      dismiss: "Hinweis zum Workspace-Konflikt schließen",
    ...
    messages: {
      ...
      forkFromHere: "Ab hier abzweigen",
      hide: "Ausblenden",
      ...
      forkUnavailable: "Abzweigen ist nicht verfügbar, während der Agent arbeitet",
    ...
    modelControls: {
      ...
      usingDefault: "Standard aus Einstellungen wird verwendet",
    ...
    observer: {
      ...
      askLabel: "Fragen zu dieser Sitzung stellen",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Änderungen werden beim Start deiner nächsten Talk-Sitzung wirksam.",
      ...
      holdToRecordSetting: "Mikrofontaste gedrückt halten zum Diktieren",
      holdToRecordSettingDescription:
        "Halte die Mikrofontaste im Editor gedrückt, sprich und lasse dann los, um Text ohne Senden einzufügen.",
      ...
      dictationDisconnected: "Diktat wurde beendet, weil der Gateway die Verbindung getrennt hat.",
      ...
      dictationReleaseToInsert: "Loslassen zum Einfügen des Diktats",
      ...
      selectedCameraUnavailable:
        "Die ausgewählte Kamera ist nicht verfügbar. Wähle eine andere Kamera oder Systemstandard.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Skript",
      readOnlyPayloadHelp:
        "Diese Payload wurde außerhalb der Control UI erstellt. Ihr Inhalt bleibt schreibgeschützt und wird beibehalten, wenn Sie andere Änderungen speichern.",
