...
export const fr: TranslationMap = {
  ...
  sessionsView: {
    ...
    viewArchived: "Afficher les archivés",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      avatarTooLarge: "L'avatar traité est toujours trop volumineux.",
  ...
  configView: {
    ...
    sessionObserver: {
      ...
      toggleHint: "Générer des résumés d'état en direct pour les sessions Control UI abonnées.",
  ...
  labsPage: {
    ...
    swarm: {
      title: "Swarm",
      description: "Laissez Code Mode orchestrer des groupes de sous-agents en parallèle.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Applications compagnons pour votre téléphone, votre montre, votre ordinateur et votre navigateur — ainsi que des plugins pour étendre les capacités de votre agent.",
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Compagnon dans la barre de menus pour votre Gateway — notifications, approbations, discussion rapide.",
      },
      windows: {
        title: "Windows",
      ...
      plugins: {
        ...
        desc: "Étendez OpenClaw avec des canaux, des outils et des Skills issus de la communauté.",
      },
    },
  },
  presence: {
  ...
  board: {
    ...
    widget: {
      ...
      rejectedDetail: "Ce widget reste inactif jusqu'à sa suppression ou son remplacement.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Pas encore de tableau de bord — l'agent actif peut épingler des widgets.",
    openSession: "Ouvrir la session",
  ...
  chat: {
    ...
    board: {
      ...
      mockPlaceholder: "Jointure de la vue tableau · {tabs} onglets · {widgets} widgets",
      mockOverview: "Aperçu",
    ...
    workspaceConflict: {
      ...
      commandHelp:
        "Exécutez ces commandes dans Bash ou zsh (Git Bash sous Windows). Si l'inspection indique que le chemin n'existe pas, le cloud l'a supprimé ; vérifiez et retirez le chemin local manuellement. Si le checkout signale un conflit de fichier/répertoire, déplacez ou supprimez le chemin local bloquant, puis réessayez. Si la référence indexée est manquante, l'avis est obsolète ; ne modifiez pas le chemin local.",
      commandsUnavailable:
    ...
    composer: {
      ...
      selectedCameraUnavailable:
        "La caméra sélectionnée n'est pas disponible. Choisissez une autre caméra ou la valeur par défaut du système.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess:
        "Un accès en écriture de l'opérateur est requis pour ouvrir cette discussion.",
