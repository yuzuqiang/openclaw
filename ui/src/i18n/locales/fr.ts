...
export const fr: TranslationMap = {
  ...
  sessionsView: {
    ...
    deleteAllArchived: "Supprimer tous les fils archivés…",
    ...
    approvalNeeded: "Approbation nécessaire",
    ...
    cloudWorkerDescendantConflict: "Worker cloud enfant : 1 conflit d’espace de travail",
    cloudWorkerDescendantConflicts: "Workers cloud enfants : {count} conflits d’espace de travail",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Les notifications sont affichées nativement par l’app OpenClaw sur ce Mac.",
  ...
  execApproval: {
    ...
    reviewRequest: "Examiner la demande d’approbation de {agent} : {command}",
  ...
  subtitles: {
    ...
    apps: "Applications complémentaires pour téléphone, montre, ordinateur et navigateur.",
    ...
    labs: "Fonctionnalités expérimentales des agents et des outils.",
    ...
    notifications: "Notifications push du navigateur provenant de votre Gateway.",
    security:
      "Authentification de la Gateway, politique d’exécution, profil des outils et approbations.",
    advanced:
  ...
  custodian: {
    ...
    subtitleCaretaker: "Configuration et maintenance du système.",
    ...
    sessionRestarted:
      "{error} OpenClaw a démarré une nouvelle session ; les messages précédents sont conservés pour le contexte.",
    unsupportedGateway: "Mettez à jour le Gateway pour poursuivre la configuration avec OpenClaw.",
    history: {
      button: "Historique",
      title: "Modifications récentes",
      description: "Modifications apportées à ce système, des plus récentes aux plus anciennes.",
      ...
      invalidEdit: "Cette modification manuelle n’a pas réussi la validation de la configuration.",
      opaqueChange:
        "La mise en forme ou les commentaires ont changé sans modification visible des chemins de configuration.",
      sources: {
  ...
  mcpServers: {
    ...
    transportStreamableHttp: "HTTP avec diffusion en continu",
    transportSse: "SSE",
    ...
    adminRequired: "La modification des serveurs MCP nécessite l’accès operator.admin.",
    enable: "Activer",
    disable: "Désactiver",
  ...
  labsPage: {
    intro:
      "Labs contient des fonctionnalités expérimentales susceptibles de changer, de ne plus fonctionner ou de disparaître d’une version à l’autre.",
    sectionTitle: "Fonctionnalités expérimentales",
    sectionDescription:
      "Les modifications sont enregistrées immédiatement et s’appliquent aux prochaines exécutions des agents.",
    ...
    codeMode: {
      title: "Mode Code",
      description:
        "Permet aux agents de combiner des outils dans des workflows JavaScript compacts et isolés.",
    },
    swarm: {
      title: "Essaim",
      description: "Permet au Mode Code d’orchestrer en parallèle des groupes de sous-agents.",
      empty: "Aucun essaim actif.",
  ...
  appsPage: {
    ...
    badgeBundledIos: "Inclus avec l’app iOS",
    badgeBundledAndroid: "Inclus avec l’app Android",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Discutez, parlez, approuvez des actions et partagez du contenu dans OpenClaw depuis iOS.",
      },
      android: {
        title: "Android",
        desc: "Votre téléphone Android comme nœud OpenClaw complet — chat, appareil photo et Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Consultez vos conversations en un coup d’œil et répondez rapidement depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "L’app compagnon Android étend OpenClaw à votre montre.",
      },
      macos: {
        title: "macOS",
        desc: "Compagnon dans la barre des menus pour votre Gateway — notifications, approbations et discussion rapide.",
      },
      windows: {
        title: "Windows",
      ...
      chrome: {
        ...
        desc: "Permettez à OpenClaw de piloter votre navigateur Chrome existant — onglets, pages et formulaires.",
      },
      plugins: {
        title: "Plugins et ClawHub",
        desc: "Étendez OpenClaw avec des canaux, des outils et des compétences créés par la communauté.",
      },
    },
  },
  presence: {
    rosterLabel: "Afficher les personnes en ligne",
  ...
  profilePage: {
    ...
    identity: {
      ...
      linkedEmails: "Adresses e-mail associées",
      linkedEmailsDescription: "Adresses e-mail associées à ce profil.",
      openSettings: "Ouvrir les paramètres d’identité de {name}",
      avatarErrors: {
  ...
  gatewayLogs: {
    ...
    autoFollow: "Suivi automatique",
    file: "Fichier : {file}",
    truncated: "Sortie du journal tronquée ; affichage de la partie la plus récente.",
  ...
  board: {
    ...
    emptyHint:
      "Votre agent peut épingler des widgets ici — essayez de lui demander une carte d’état.",
    actionFailed: "La modification du tableau de bord n’a pas pu être enregistrée.",
    actionInProgress:
      "Une autre modification du tableau de bord est toujours en cours d’enregistrement.",
    announcement: {
      moved: "{title} déplacé.",
    ...
    widget: {
      cellLabel:
        "Widget du tableau de bord : {title}. Utilisez les touches fléchées pour naviguer. Maintenez la touche Alt enfoncée et appuyez sur une touche fléchée pour le déplacer.",
      ...
      appStaleDetail:
        "Son serveur, sa ressource ou la transcription dont elle provient n’est plus disponible.",
      retry: "Réessayer",
  ...
  workboard: {
    ...
    dashboardEmpty:
      "Aucun tableau de bord pour le moment — l’agent actif peut épingler des widgets.",
    openSession: "Ouvrir la session",
  ...
  chat: {
    ...
    board: {
      ...
      dockRight: "Ancrer la discussion à droite",
      dockBottom: "Ancrer la discussion en bas",
      dockHidden: "Masquer la discussion",
      resizeDock: "Redimensionner la zone de discussion",
      reopenChat: "Afficher la discussion",
      workboardCard: "Carte du tableau de travail : {title}, {status}",
      defaultTab: "Principal",
      mockPlaceholder: "Séparation de la vue du tableau · {tabs} onglets · {widgets} widgets",
      mockOverview: "Aperçu",
      ...
      resetDescription:
        "Le contexte de la conversation sera réinitialisé. Votre tableau de bord restera inchangé.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw a conservé vos versions locales et appliqué les autres modifications du cloud. Inspectez le résultat préparé ou utilisez sa version pour un chemin en conflit.",
      morePaths: "+{count} autres chemins",
      ...
      takeCloud: "Utiliser la première version cloud",
      copyInspectCommand: "Copier la commande d’inspection du cloud",
      copyTakeCommand: "Copier la commande pour utiliser la version cloud",
      commandHelp:
        "Exécutez ces commandes dans Bash ou zsh (Git Bash sous Windows). Si l’inspection indique que le chemin n’existe pas, cela signifie qu’il a été supprimé du cloud ; vérifiez, puis supprimez manuellement le chemin local. Si checkout signale un conflit de fichier ou de répertoire, déplacez ou supprimez le chemin local bloquant, puis réessayez. Si la référence préparée est absente, la notification est obsolète ; ne modifiez pas le chemin local.",
      commandsUnavailable:
        "Ce nom de fichier contient des caractères de contrôle du terminal. OpenClaw ne créera donc pas de commande shell copiable pour celui-ci. Inspectez directement la référence préparée et saisissez manuellement le chemin avec précaution.",
      dismiss: "Ignorer la notification de conflit d’espace de travail",
      ...
      eventDescription:
        "Les versions locales ont été conservées pour ces chemins ; les autres modifications dans le cloud ont été appliquées.",
    },
    compaction: {
    ...
    messages: {
      ...
      rewindConfirm: "Revenir à l’état précédant ce message ?",
      rewindToHere: "Revenir jusqu’ici",
      rewindUnavailable: "Impossible de revenir en arrière pendant que l’agent travaille",
      forkUnavailable: "Impossible de créer une branche pendant que l’agent travaille",
    ...
    modelControls: {
      ...
      reasoning: "Raisonnement",
      speed: "Vitesse",
      sessionOverride: "Remplacement pour la session",
      usingDefault: "Utilisation de la valeur par défaut des Réglages",
      resetToDefault: "Rétablir la valeur par défaut ({model})",
    },
    sideChat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Maintenez le bouton du microphone de la zone de saisie, parlez, puis relâchez-le pour insérer le texte sans l’envoyer.",
      ...
      dictationBrowserAudioUnsupported:
        "Ce navigateur ne peut pas capturer l’audio de la dictée à 8 kHz.",
      dictationConnecting: "Démarrage de la dictée…",
      dictationDisconnected: "La dictée s’est arrêtée en raison de la déconnexion du Gateway.",
      dictationFailed: "Échec de la dictée.",
      dictationFinalizing: "Finalisation de la dictée…",
      dictationFinalizationTimedOut:
        "La dictée s’est arrêtée avant que la dernière transcription partielle puisse être finalisée.",
      ...
      selectedCameraUnavailable:
        "La caméra sélectionnée n’est pas disponible. Choisissez une autre caméra ou l’option par défaut du système.",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Ce widget doit être généré à nouveau pour pouvoir être exporté sous forme d’image.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess:
        "Un accès en écriture en tant qu’opérateur est requis pour ouvrir cette discussion.",
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "S’exécute toutes les secondes",
