...
export const pl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nie wyczyszczono żadnej zapisanej sesji WhatsApp. Może już jej nie być lub jej katalog uwierzytelniania może wymagać ręcznego wyczyszczenia.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Workery w chmurze wymagają środowiska uruchomieniowego OpenClaw; wybrano {runtime}.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      avatarTooLarge: "Przetworzony awatar jest wciąż za duży.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Powiadomienia są wyłączone dla OpenClaw w macOS. Zezwól na nie w Ustawieniach systemowych > Powiadomienia.",
    },
    appearance: {
      theme: "Motyw",
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Pokazuj najnowszą aktywność asystenta lub narzędzi pod działającymi sesjami.",
    },
    sessionObserver: {
      title: "Obserwator sesji",
      hint: "Podsumowuj długo działające sesje za pomocą niewielkiego modelu narzędziowego.",
  ...
  subtitles: {
    ...
    notifications: "Powiadomienia push z przeglądarki z Twojego Gateway.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Konfiguracja i pielęgnacja systemu.",
    ...
    connectionChanged:
      "Połączenie z Gateway uległo zmianie. Ponów próbę, aby kontynuować tę konfigurację.",
    sessionRestarted:
    ...
    history: {
      ...
      opaqueChange:
        "Formatowanie lub komentarze zmieniły się bez widocznych zmian ścieżki konfiguracji.",
      sources: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel} działa z pogorszoną jakością — zapytaj mnie, co się stało",
  ...
  mcpServers: {
    ...
    targetInvalid: "Podaj URL dla transportów HTTP lub prawidłowy wiersz poleceń dla stdio.",
  ...
  mcpPage: {
    connectorsLink: "Odkryj konektory jednym kliknięciem na stronie Plugins.",
    servers: "Serwery",
    oauth: "OAuth",
    filtered: "Filtrowane",
  ...
  labsPage: {
    intro:
      "Labs zawiera funkcje eksperymentalne, które mogą się zmienić, przestać działać lub zniknąć między wydaniami.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Pozwól agentom łączyć narzędzia w kompaktowe, izolowane przepływy pracy JavaScript.",
    },
    swarm: {
      title: "Swarm",
      description: "Pozwól, aby Code Mode orkiestrował grupy podagentów równolegle.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Twój telefon z Androidem jako pełnoprawny węzeł OpenClaw — czat, kamera i Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      plugins: {
        ...
        desc: "Rozszerz OpenClaw o kanały, narzędzia i umiejętności ze społeczności.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      profileUnavailable: "Nie można załadować profilu Twojej tożsamości.",
      ...
      displayName: "Nazwa wyświetlana",
      displayNameDescription: "Wyświetlane innym osobom korzystającym z tego gateway.",
  ...
  gatewayLogs: {
    ...
    autoFollow: "Automatyczne śledzenie",
    file: "Plik: {file}",
    truncated: "Wynik logów obcięty; wyświetlanie najnowszego fragmentu.",
  ...
  board: {
    ...
    emptyHint: "Twój agent może tutaj przypinać widżety — spróbuj poprosić o kartę statusu.",
    ...
    widget: {
      cellLabel:
        "Widżet pulpitu: {title}. Użyj klawiszy strzałek, aby nawigować. Przytrzymaj Alt i naciśnij strzałkę, aby go przenieść.",
      ...
      appStaleDetail: "Jego serwer, zasób lub transkrypcja źródłowa nie jest już dostępna.",
      retry: "Ponów",
      frameResolverMissing: "Treść widżetu jest niedostępna.",
      ...
      sandboxOriginRequired:
        "Autoryzacja widżetu nie powiodła się po wielokrotnych próbach odświeżenia. Jeśli gateway działa za reverse proxy lub tunelem, który nie kieruje ruchu do portu piaskownicy widżetu, ustaw mcp.apps.sandboxOrigin na dedykowany publiczny origin kierowany do listenera piaskownicy.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Brak pulpitu — agent roboczy może przypinać widżety.",
    openSession: "Otwórz sesję",
  ...
  chat: {
    ...
    board: {
      ...
      resetDescription: "Kontekst rozmowy zostanie zresetowany. Twój panel pozostanie.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw zachował Twoje wersje lokalne i zastosował pozostałe zmiany z chmury. Sprawdź przygotowany wynik lub wybierz wersję z chmury dla ścieżki w konflikcie.",
      ...
      takeCloud: "Wybierz pierwszą wersję z chmury",
      copyInspectCommand: "Kopiuj polecenie sprawdzenia w chmurze",
      copyTakeCommand: "Kopiuj polecenie wyboru wersji z chmury",
      commandHelp:
        "Uruchom je w Bash lub zsh (Git Bash w systemie Windows). Jeśli sprawdzenie wskazuje, że ścieżka nie istnieje, chmura ją usunęła; zweryfikuj i usuń ścieżkę lokalną ręcznie. Jeśli checkout zgłasza konflikt pliku/katalogu, przenieś lub usuń blokującą ścieżkę lokalną, a następnie spróbuj ponownie. Jeśli brakuje przygotowanej referencji, powiadomienie jest nieaktualne; nie zmieniaj ścieżki lokalnej.",
      commandsUnavailable:
        "Ta nazwa pliku zawiera terminalowe znaki sterujące, więc OpenClaw nie utworzy dla niej polecenia powłoki do skopiowania. Sprawdź przygotowaną referencję bezpośrednio i ostrożnie wprowadź ścieżkę ręcznie.",
      ...
      eventTitleMany: "Zastosowano wynik z chmury z liczbą konfliktów: {count}",
      eventDescription:
    ...
    observer: {
      ...
      running: "W toku",
      checksPassing: "{count} zaliczono",
      checksFailing: "{count} nie powiodło się",
      ...
      health: {
        ...
        grinding: "W trakcie pracy",
        stuck: "Utknięto",
        "waiting-on-user": "Czeka na Ciebie",
        "wrapping-up": "Kończenie",
        done: "Gotowe",
        failed: "Niepowodzenie",
      },
    },
    ...
    composer: {
      ...
      dictationFinalizationTimedOut:
        "Dyktowanie zostało zatrzymane, zanim ostatni częściowy transkrypt mógł zostać sfinalizowany.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "Aby otworzyć tę dyskusję, wymagany jest dostęp operatora do zapisu.",
