...
export const pl: TranslationMap = {
  ...
  sessionsView: {
    ...
    cloudWorkerPlacementConflict:
      "Proces roboczy w chmurze: {state} · 1 konflikt obszaru roboczego",
    cloudWorkerPlacementConflicts:
      "Proces roboczy w chmurze: {state} · Konflikty obszarów roboczych: {count}",
    cloudWorkerDescendantConflict:
      "Podrzędny proces roboczy w chmurze: 1 konflikt obszaru roboczego",
    cloudWorkerDescendantConflicts:
      "Podrzędne procesy robocze w chmurze: konflikty obszarów roboczych: {count}",
  ...
  gatewayLogs: {
    title: "Dzienniki",
    subtitle: "Dzienniki plikowe Gateway (JSONL).",
    ...
    autoFollow: "Automatyczne śledzenie",
    file: "Plik: {file}",
    truncated: "Dane wyjściowe dziennika zostały obcięte; wyświetlany jest najnowszy fragment.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Nie ma jeszcze pulpitu — agent roboczy może przypinać widżety.",
    openSession: "Otwórz sesję",
  ...
  chat: {
    ...
    outputTokens: "Tokeny wyjściowe: {count}",
    ...
    board: {
      ...
      workboardCard: "Karta obszaru roboczego: {title}, {status}",
      defaultTab: "Główna",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw zachował Twoje wersje lokalne i zastosował pozostałe zmiany z chmury. Sprawdź przygotowany wynik lub wybierz wersję z chmury dla ścieżki powodującej konflikt.",
      morePaths: "+{count} ścieżek więcej",
      ...
      copyInspectCommand: "Kopiuj polecenie sprawdzania wersji z chmury",
      copyTakeCommand: "Kopiuj polecenie pobrania wersji z chmury",
      commandHelp:
        "Uruchom te polecenia w Bash lub zsh (Git Bash w systemie Windows). Jeśli polecenie sprawdzające informuje, że ścieżka nie istnieje, została ona usunięta z chmury; zweryfikuj to i ręcznie usuń ścieżkę lokalną. Jeśli checkout zgłasza konflikt pliku lub katalogu, przenieś albo usuń blokującą ścieżkę lokalną, a następnie spróbuj ponownie. Jeśli brakuje odwołania do przygotowanego wyniku, powiadomienie jest nieaktualne; nie zmieniaj ścieżki lokalnej.",
      commandsUnavailable:
        "Ta nazwa pliku zawiera terminalowe znaki sterujące, dlatego OpenClaw nie utworzy dla niej polecenia powłoki możliwego do skopiowania. Sprawdź bezpośrednio odwołanie do przygotowanego wyniku i ostrożnie wprowadź ścieżkę ręcznie.",
      ...
      eventDescription:
        "Lokalne wersje zostały zachowane dla tych ścieżek; pozostałe zmiany z chmury zostały zastosowane.",
    },
    compaction: {
