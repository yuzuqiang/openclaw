...
export const vi: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Không có phiên WhatsApp đã lưu nào được xóa. Có thể phiên đã không còn, hoặc thư mục xác thực của nó cần được dọn dẹp thủ công.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Worker đám mây yêu cầu runtime OpenClaw; {runtime} đã được chọn.",
    ...
    gitCheckUnavailable: "Không thể xác minh Git cho thư mục này. Hãy chọn lại để thử lại.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG hoặc WebP. Hình ảnh được cắt từ giữa và đổi kích thước về 512px.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Thông báo được hiển thị bản địa bởi ứng dụng OpenClaw trên máy Mac này.",
      ...
      nativeBlockedHint:
        "Thông báo đã bị tắt cho OpenClaw trong macOS. Cho phép chúng trong Cài đặt hệ thống > Thông báo.",
    },
    appearance: {
      theme: "Giao diện",
    ...
    sidebarPrefs: {
      title: "Thanh bên",
      hint: "Chọn những gì hiển thị khi các phiên đang chạy.",
    ...
    sessionObserver: {
      ...
      hint: "Tóm tắt các phiên chạy lâu bằng một mô hình tiện ích nhỏ.",
      ...
      modelPickerHint:
        "Được dùng cho các bản tóm tắt của trình quan sát và các tác vụ tiện ích ngắn khác.",
  ...
  subtitles: {
    ...
    advanced: "Tất cả các mục cấu hình còn lại, cùng trình chỉnh sửa tệp thô.",
  ...
  custodian: {
    ...
    newAgent: "Agent mới",
    hatchDraft: "Thức dậy nào, bạn của tôi!",
    ...
    history: {
      ...
      opaqueChange:
        "Định dạng hoặc chú thích đã thay đổi mà không có thay đổi đường dẫn cấu hình hiển thị.",
      sources: {
    ...
    nudge: {
      configReload: "Việc tải lại cấu hình đã dừng — hãy hỏi tôi điều gì đã xảy ra",
      channelAuth: "Xác thực {channel} bị suy giảm — hãy hỏi tôi điều gì đã xảy ra",
      channelDisconnected: "{channel} vừa ngắt kết nối — hãy hỏi tôi điều gì đã xảy ra",
      channelDegraded: "{channel} đang bị suy giảm — hãy hỏi tôi điều gì đã xảy ra",
  ...
  mcpServers: {
    ...
    nameInvalid: "Tên máy chủ dùng chữ cái, chữ số, dấu chấm, dấu gạch ngang hoặc gạch dưới.",
    targetInvalid: "Nhập URL cho truyền tải HTTP hoặc một dòng lệnh hợp lệ cho stdio.",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Các thay đổi được lưu ngay lập tức và áp dụng cho các lần chạy tác nhân trong tương lai.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Cho phép tác nhân kết hợp các công cụ trong quy trình JavaScript gọn nhẹ, được cách ly an toàn.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Ứng dụng đồng hành cho điện thoại, đồng hồ, máy tính và trình duyệt của bạn — cùng các plugin mở rộng khả năng của agent.",
    ...
    cards: {
      ...
      chrome: {
        ...
        desc: "Để OpenClaw điều khiển Chrome hiện có của bạn — thẻ, trang và biểu mẫu.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "Tên hiển thị",
      displayNameDescription: "Hiển thị cho những người khác dùng gateway này.",
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Chọn hình ảnh 10 MB hoặc nhỏ hơn.",
  ...
  board: {
    ...
    emptyHint: "Tác nhân của bạn có thể ghim tiện ích ở đây — hãy thử yêu cầu một thẻ trạng thái.",
    ...
    widget: {
      ...
      appStaleTitle: "Ứng dụng được ghim này đã cũ",
      ...
      sandboxOriginRequired:
        "Ủy quyền widget thất bại sau nhiều lần thử làm mới. Nếu gateway chạy sau reverse proxy hoặc tunnel không định tuyến cổng sandbox của widget, hãy đặt mcp.apps.sandboxOrigin thành một origin công khai chuyên dụng được định tuyến đến listener của sandbox.",
      ...
      disabledPlugin: "Widget từ plugin bị tắt {pluginId}",
    },
  },
  workboard: {
    widget: {
      ...
      cardIdRequired: "Widget này cần prop cardId.",
    ...
    dashboardEmpty: "Chưa có trang tổng quan — tác nhân đang làm việc có thể ghim widget.",
    openSession: "Mở phiên",
  ...
  chat: {
    ...
    board: {
      ...
      dockMenu: "Khay trò chuyện: {dock}",
      dockLeft: "Gắn trò chuyện bên trái",
      dockRight: "Gắn trò chuyện bên phải",
      dockBottom: "Gắn trò chuyện dưới cùng",
      dockHidden: "Ẩn trò chuyện",
      resizeDock: "Đổi kích thước khay trò chuyện",
      reopenChat: "Hiện trò chuyện",
      workboardCard: "Thẻ bảng làm việc: {title}, {status}",
      defaultTab: "Chính",
    ...
    workspaceConflict: {
      titleOne: "1 xung đột không gian làm việc trên cloud",
      titleMany: "{count} xung đột không gian làm việc trên cloud",
      description:
        "OpenClaw đã giữ các phiên bản cục bộ của bạn và áp dụng các thay đổi khác từ cloud. Kiểm tra kết quả đã dàn dựng hoặc lấy phiên bản của nó cho một đường dẫn bị xung đột.",
      morePaths: "+{count} đường dẫn khác",
      stagedResult: "Kết quả cloud đã dàn dựng",
      copyStagedResult: "Sao chép ref kết quả đã dàn dựng",
      inspectCloud: "Kiểm tra phiên bản cloud đầu tiên",
      takeCloud: "Lấy phiên bản cloud đầu tiên",
      copyInspectCommand: "Sao chép lệnh kiểm tra cloud",
      copyTakeCommand: "Sao chép lệnh lấy phiên bản cloud",
      commandHelp:
        "Chạy các lệnh này trong Bash hoặc zsh (Git Bash trên Windows). Nếu lệnh inspect báo đường dẫn không tồn tại, cloud đã xóa nó; hãy xác minh và xóa đường dẫn cục bộ theo cách thủ công. Nếu checkout báo xung đột tập tin/thư mục, hãy di chuyển hoặc xóa đường dẫn cục bộ đang chặn, rồi thử lại. Nếu ref đã dàn dựng bị thiếu, thông báo đã lỗi thời; đừng thay đổi đường dẫn cục bộ.",
      commandsUnavailable:
        "Tên tập tin này chứa ký tự điều khiển của terminal, nên OpenClaw sẽ không tạo lệnh shell có thể sao chép cho nó. Hãy kiểm tra ref đã dàn dựng trực tiếp và nhập đường dẫn thủ công một cách cẩn thận.",
      dismiss: "Bỏ qua thông báo xung đột không gian làm việc",
      eventSender: "Không gian làm việc trên cloud",
      eventTitleOne: "Kết quả cloud được áp dụng với 1 xung đột",
      eventTitleMany: "Kết quả cloud được áp dụng với {count} xung đột",
      eventDescription:
        "Các phiên bản cục bộ được giữ cho những đường dẫn này; các thay đổi khác từ cloud đã được áp dụng.",
    },
    compaction: {
    ...
    turnRecap: {
      doneIn: "Hoàn thành trong {duration}",
      tokens: "{count} token",
      tokensOne: "1 token",
    },
    commands: {
    ...
    observer: {
      ...
      askBusy: "Observer đang trả lời một câu hỏi khác.",
      askUnavailable: "Observer không thể trả lời ngay bây giờ.",
      health: {
        "on-track": "Đúng hướng",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Giữ nút micrô trong trình soạn, nói, rồi thả ra để chèn văn bản mà không gửi.",
      ...
      dictationFinalizationTimedOut:
        "Đọc chính tả đã dừng trước khi bản ghi tạm cuối cùng có thể được hoàn tất.",
      dictationProviderUnavailable:
        "Không có nhà cung cấp phiên âm nào được cấu hình cho đọc chính tả.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "Cần quyền ghi của operator để mở thảo luận này.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Script",
      readOnlyPayloadHelp:
        "Payload này được tạo bên ngoài Control UI. Nội dung của nó luôn ở chế độ chỉ đọc và được giữ nguyên khi bạn lưu các thay đổi khác.",
