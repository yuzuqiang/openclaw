...
export const vi: TranslationMap = {
  ...
  newSession: {
    ...
    gitCheckUnavailable: "Không thể xác minh Git cho thư mục này. Hãy chọn lại thư mục để thử lại.",
  ...
  sessionsView: {
    ...
    cloudWorkerDescendantConflicts: "Các Cloud worker con: {count} xung đột không gian làm việc",
  ...
  configView: {
    ...
    sessionObserver: {
      ...
      modelPickerHint:
        "Được dùng cho các bản tóm tắt của trình giám sát và các tác vụ tiện ích ngắn khác.",
      modelCatalogUnavailable: "Danh mục mô hình chỉ định không khả dụng",
      auto: "Tự động (mặc định của nhà cung cấp)",
      disabled: "Đã tắt",
      toggleNote: "Cập nhật trình giám sát phiên của Control UI",
  ...
  profilePage: {
    ...
    identity: {
      ...
      notSet: "Chưa thiết lập danh tính.",
  ...
  board: {
    ...
    widget: {
      ...
      kindHtml: "HTML",
      kindPlugin: "Plugin",
      pluginLoading: "Đang tải tiện ích plugin…",
      disabledPlugin: "Tiện ích từ plugin đã tắt {pluginId}",
    },
  },
  workboard: {
    widget: {
      ...
      cardIdRequired: "Tiện ích này cần thuộc tính cardId.",
    ...
    dashboardEmpty: "Chưa có bảng điều khiển — tác nhân đang hoạt động có thể ghim tiện ích.",
    openSession: "Mở phiên",
  ...
  chat: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw đã giữ lại các phiên bản cục bộ của bạn và áp dụng những thay đổi khác từ đám mây. Hãy kiểm tra kết quả tạm lưu hoặc lấy phiên bản đám mây cho đường dẫn bị xung đột.",
      morePaths: "+{count} đường dẫn khác",
      stagedResult: "Kết quả đám mây đã tạm lưu",
      copyStagedResult: "Sao chép tham chiếu kết quả đã tạm lưu",
      ...
      commandHelp:
        "Chạy các lệnh này trong Bash hoặc zsh (Git Bash trên Windows). Nếu lệnh kiểm tra cho biết đường dẫn không tồn tại, thì đám mây đã xóa đường dẫn đó; hãy xác minh và xóa đường dẫn cục bộ theo cách thủ công. Nếu lệnh checkout báo xung đột tệp/thư mục, hãy di chuyển hoặc xóa đường dẫn cục bộ đang cản trở rồi thử lại. Nếu thiếu tham chiếu đã tạm lưu, thông báo này đã lỗi thời; đừng thay đổi đường dẫn cục bộ.",
      commandsUnavailable:
        "Tên tệp này chứa các ký tự điều khiển thiết bị đầu cuối, vì vậy OpenClaw sẽ không tạo lệnh shell có thể sao chép cho tên tệp này. Hãy kiểm tra trực tiếp tham chiếu đã tạm lưu và nhập đường dẫn theo cách thủ công một cách cẩn thận.",
      dismiss: "Bỏ qua thông báo xung đột không gian làm việc",
      eventSender: "Không gian làm việc đám mây",
      eventTitleOne: "Đã áp dụng kết quả đám mây với 1 xung đột",
      eventTitleMany: "Đã áp dụng kết quả đám mây với {count} xung đột",
      eventDescription:
        "Các phiên bản cục bộ đã được giữ lại cho những đường dẫn này; các thay đổi khác trên đám mây đã được áp dụng.",
    },
    compaction: {
    ...
    observer: {
      title: "Trình theo dõi phiên",
      expand: "Mở rộng trình theo dõi phiên",
      collapse: "Thu gọn trình theo dõi phiên",
      plan: "Kế hoạch",
      progress: "{completed} trên {total}",
      pullRequests: "Yêu cầu kéo",
      running: "Đang chạy",
      checksPassing: "{count} đạt",
      checksFailing: "{count} không đạt",
      checksPending: "{count} đang chạy",
      askLabel: "Hỏi về phiên này",
      askPlaceholder: "Tại sao nó lại làm như vậy?",
      askSubmit: "Hỏi",
      askPending: "Đang kiểm tra các quan sát…",
      askBusy: "Trình quan sát đang trả lời một câu hỏi khác.",
      askUnavailable: "Trình quan sát hiện không thể trả lời.",
      health: {
  ...
  cron: {
    ...
    form: {
      ...
      script: "Tập lệnh",
      readOnlyPayloadHelp:
        "Payload này được tạo bên ngoài Control UI. Nội dung của payload vẫn ở chế độ chỉ đọc và được giữ nguyên khi bạn lưu các thay đổi khác.",
